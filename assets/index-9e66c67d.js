...
Q.StrictMode = vl;
Q.Suspense = kl;
Q.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED = Zl;
 ...
 */ (function (e) {
  function t(T, I) {
    ...
    e: for (; 0 < B; ) {
      var t1 = (B - 1) >>> 1,
        c1 = T[t1];
      if (0 < l(c1, I)) (T[t1] = I), (T[B] = c1), (B = t1);
      else break e;
    }
  }
  function n(T) {
  ...
  function r(T) {
    ...
    if (B !== I) {
      ...
      e: for (var t1 = 0, c1 = T.length, B2 = c1 >>> 1; t1 < B2; ) {
        ...
        if (0 > l(_3, B))
          de < c1 && 0 > l(He, _3)
            ? ((T[t1] = He), (T[de] = B), (t1 = de))
            : ((T[t1] = _3), (T[ke] = B), (t1 = ke));
        else if (de < c1 && 0 > l(He, B)) (T[t1] = He), (T[de] = B), (t1 = de);
        else break e;
      }
    }
    return I;
  ...
  function w(T) {
    if (((x = !1), h(T), !y))
      if (n(a) !== null) (y = !0), x1(j);
      else {
        var I = n(c);
        I !== null && Z1(w, I.startTime - T);
      }
  }
  function j(T, I) {
    (y = !1), x && ((x = !1), C(E), (E = -1)), (v = !0);
    var B = p;
    try {
      for (
        h(I), d = n(a);
        d !== null && (!(d.expirationTime > I) || (T && !W()));

      ) {
        var t1 = d.callback;
        if (typeof t1 == "function") {
          (d.callback = null), (p = d.priorityLevel);
          var c1 = t1(d.expirationTime <= I);
          (I = e.unstable_now()),
            typeof c1 == "function" ? (d.callback = c1) : d === n(a) && r(a),
            h(I);
        } else r(a);
        d = n(a);
      }
      if (d !== null) var B2 = !0;
        ...
        var ke = n(c);
        ke !== null && Z1(w, ke.startTime - I), (B2 = !1);
      }
      return B2;
    } finally {
      (d = null), (p = B), (v = !1);
    ...
    (e.unstable_scheduleCallback = function (T, I, B) {
      ...
      switch (
        (typeof B == "object" && B !== null
          ? ((B = B.delay), (B = typeof B == "number" && 0 < B ? t1 + B : t1))
          : (B = t1),
        T)
      ) {
        case 1:
      ...
      return (
        ...
        B > t1
          ? ((T.sortIndex = B),
            ...
            n(a) === null &&
              T === n(c) &&
              (x ? (C(E), (E = -1)) : (x = !0), Z1(w, B - t1)))
          : ((T.sortIndex = c1), t(a, T), y || v || ((y = !0), x1(j))),
        T
      );
    }),
...
function F6(e) {
  if (U2(e) !== e) throw Error(_(188));
}
function Kl(e) {
  var t = e.alternate;
  if (!t) {
    if (((t = U2(e)), t === null)) throw Error(_(188));
    return t !== e ? null : e;
  }
  for (var n = e, r = t; ; ) {
    var l = n.return;
...
var H8 = b1.unstable_scheduleCallback,
  V6 = b1.unstable_cancelCallback,
  ql = b1.unstable_shouldYield,
  bl = b1.unstable_requestPaint,
  d1 = b1.unstable_now,
  Jl = b1.unstable_getCurrentPriorityLevel,
  kr = b1.unstable_ImmediatePriority,
  Y8 = b1.unstable_UserBlockingPriority,
  u4 = b1.unstable_NormalPriority,
  es = b1.unstable_LowPriority,
  X8 = b1.unstable_IdlePriority,
  F4 = null,
  Ze = null;
function ts(e) {
...
var ge = Math.clz32 ? Math.clz32 : ls,
  ns = Math.log,
  rs = Math.LN2;
function ls(e) {
...
function a4(e, t) {
  ...
  if (o !== 0) {
    var u = o & ~l;
    u !== 0 ? (r = U3(u)) : ((s &= o), s !== 0 && (r = U3(s)));
  } else (o = n & ~l), o !== 0 ? (r = U3(o)) : s !== 0 && (r = U3(s));
  if (r === 0) return 0;
  if (
    t !== 0 &&
    t !== r &&
...
function T3(e, t) {
  e.blockedOn === t &&
    ...
    E5 ||
      ((E5 = !0),
      b1.unstable_scheduleCallback(b1.unstable_NormalPriority, cs)));
}
function lt(e) {
  function t(l) {
    return T3(l, e);
...
function Lr(e, t, n, r) {
  if (c4) {
    var l = N5(e, t, n, r);
    if (l === null) Vn(e, t, r, f4, n), U6(e, r);
    else if (as(l, e, t, n, r)) r.stopPropagation();
    else if ((U6(e, r), t & 4 && -1 < us.indexOf(e))) {
      for (; l !== null; ) {
        var s = kt(l);
        if (
          (s !== null && q8(s),
          (s = N5(e, t, n, r)),
          s === null && Vn(e, t, r, f4, n),
          s === l)
        )
          break;
        l = s;
    ...
    } else Vn(e, t, r, null, n);
  }
}
var f4 = null;
function N5(e, t, n, r) {
  if (((f4 = null), (e = wr(r)), (e = A2(e)), e !== null))
    if (((t = U2(e)), t === null)) e = null;
...
var M3 = {
  ...
  W6 = te(V4),
  ps = o1({}, V4, { dataTransfer: 0 }),
  hs = te(ps),
  ms = o1({}, wt, { relatedTarget: 0 }),
  Pn = te(ms),
  vs = o1({}, M3, { animationName: 0, elapsedTime: 0, pseudoElement: 0 }),
  ys = te(vs),
  gs = o1({}, M3, {
...
var Ss = o1({}, wt, {
  ...
  Es = te(Zs),
  Ns = o1({}, M3, { propertyName: 0, elapsedTime: 0, pseudoElement: 0 }),
  Ts = te(Ns),
  Ps = o1({}, V4, {
    deltaX: function (e) {
  ...
  Os = te(Ps),
  Rs = [9, 13, 27, 32],
  Zr = Ve && "CompositionEvent" in window,
  H3 = null;
Ve && "documentMode" in document && (H3 = document.documentMode);
var Is = Ve && "TextEvent" in window && !H3,
  l0 = Ve && (!Zr || (H3 && 8 < H3 && 11 >= H3)),
...
function a0(e) {
  if (e.propertyName === "value" && U4(st)) {
    var t = [];
    o0(t, st, e, wr(e)), B8(Vs, t);
  }
}
function Bs(e, t, n) {
  e === "focusin"
...
function Ws(e, t) {
  if (e === "click") return U4(t);
}
function Qs(e, t) {
  if (e === "input" || e === "change") return U4(t);
}
function Hs(e, t) {
  return (e === t && (e !== 0 || 1 / e === 1 / t)) || (e !== e && t !== t);
}
var we = typeof Object.is == "function" ? Object.is : Hs;
function it(e, t) {
  if (we(e, t)) return !0;
...
var Xs = Ve && "documentMode" in document && 11 >= document.documentMode,
  G2 = null,
  T5 = null,
  X3 = null,
  P5 = !1;
...
function B4(e) {
  ...
  var t = K2[e],
    n;
  for (n in t) if (t.hasOwnProperty(n) && n in d0) return (In[e] = t[n]);
  return e;
}
  ...
  B8(function () {
    ...
    e: {
      ...
      if (p !== void 0) {
        ...
        for (var f = c, h; f !== null; ) {
          ...
          if (
            (h.tag === 5 &&
              w !== null &&
              ((h = w),
              C !== null && ((w = tt(f, C)), w != null && x.push(ut(f, w, h)))),
            A)
          )
            break;
          f = f.return;
        ...
        0 < x.length &&
          ((p = new v(p, y, null, n, m)), d.push({ event: p, listeners: x }));
      }
    }
    if (!(t & 7)) {
      e: {
        ...
        if (
          ...
          if (
            ...
            (A = v == null ? p : q2(v)),
            (h = y == null ? p : q2(y)),
            (p = new x(w, f + "leave", v, n, m)),
            (p.target = A),
            (p.relatedTarget = h),
            (w = null),
            A2(m) === c &&
              ((x = new x(C, f + "enter", y, n, m)),
              (x.target = h),
              (x.relatedTarget = A),
              (w = x)),
            (A = w),
            ...
            t: {
              for (x = v, C = y, f = 0, h = x; h; h = W2(h)) f++;
              for (h = 0, w = C; w; w = W2(w)) h++;
              for (; 0 < f - h; ) (x = W2(x)), f--;
              for (; 0 < h - f; ) (C = W2(C)), h--;
              for (; f--; ) {
      ...
      switch (((S = c ? q2(c) : window), e)) {
        case "focusin":
          (G6(S) || S.contentEditable === "true") &&
            ((G2 = S), (T5 = c), (X3 = null));
          break;
        case "focusout":
          X3 = T5 = G2 = null;
      ...
      if (Zr)
        ...
        X2
          ? s0(e, n) && (E = "onCompositionEnd")
          : e === "keydown" && n.keyCode === 229 && (E = "onCompositionStart");
      E &&
        (l0 &&
          n.locale !== "ko" &&
          (X2 || E !== "onCompositionStart"
            ? E === "onCompositionEnd" && X2 && (M = r0())
            : ((e2 = m),
              (Sr = "value" in e2 ? e2.value : e2.textContent),
              (X2 = !0))),
        (S = d4(c, E)),
        0 < S.length &&
          ((E = new Q6(E, e, null, n, m)),
          d.push({ event: E, listeners: S }),
          M ? (E.data = M) : ((M = i0(n)), M !== null && (E.data = M)))),
        (M = Is ? zs(e, n) : Ds(e, n)) &&
...
var z5 = typeof setTimeout == "function" ? setTimeout : void 0,
...
function o9(e, t, n) {
  if (O1.current !== p2) throw Error(_(168));
  b(O1, t), b(W1, n);
}
function x0(e, t, n) {
  var r = e.stateNode;
...
function k0(e, t, n) {
  (se[ie++] = ze), (se[ie++] = De), (se[ie++] = R2), (R2 = e);
  var r = ze;
  e = De;
  var l = 32 - ge(r) - 1;
  (r &= ~(1 << l)), (n += 1);
  ...
  switch (e.tag) {
    ...
    case 13:
      return (
        ...
        t !== null
          ? ((n = R2 !== null ? { id: ze, overflow: De } : null),
            (e.memoizedState = {
              dehydrated: t,
              treeContext: n,
...
function zt(e) {
  ...
  if (
    ((t = e.tag !== 3) &&
      !(t = e.tag !== 5) &&
      ((t = e.type),
      (t = t !== "head" && t !== "body" && !I5(e.type, e.memoizedProps))),
    t && (t = K1))
  ) {
    if (V5(e)) throw (M0(), Error(_(418)));
...
function L0(e, t, n, r) {
  var l = t.interleaved;
  return (
    l === null ? ((n.next = n), zr(t)) : ((n.next = l.next), (l.next = n)),
    (t.interleaved = n),
    Be(e, r)
  );
}
...
function o2(e, t, n) {
  ...
  return (
    (l = r.interleaved),
    l === null ? ((t.next = t), zr(r)) : ((t.next = l.next), (l.next = t)),
    (r.interleaved = t),
    Be(e, n)
  );
}
...
function x4(e, t, n, r) {
  ...
  if (s !== null) {
    ...
    (z2 |= o), (e.lanes = o), (e.memoizedState = d);
  }
}
function d9(e, t, n) {
...
var Q4 = {
  isMounted: function (e) {
    return (e = e._reactInternals) ? U2(e) === e : !1;
  },
...
function Z0(e) {
  ...
  function l(C, f) {
    return (C = c2(C, f)), (C.index = 0), (C.sibling = null), C;
  }
  function s(C, f, h) {
    return (
      (C.index = h),
  ...
  function u(C, f, h, w) {
    return f === null || f.tag !== 6
      ? ((f = Gn(h, C.mode, w)), (f.return = C), f)
      : ((f = l(f, h)), (f.return = C), f);
  }
  function a(C, f, h, w) {
    var j = h.type;
    return j === Y2
      ? m(C, f, h.props.children, w, h.key)
      : f !== null &&
        (f.elementType === j ||
          (typeof j == "object" &&
            j !== null &&
            j.$$typeof === Ge &&
            h9(j) === f.type))
      ? ((w = l(f, h.props)), (w.ref = O3(C, f, h)), (w.return = C), w)
      : ((w = r4(h.type, h.key, h.props, null, C.mode, w)),
        (w.ref = O3(C, f, h)),
        (w.return = C),
        w);
  }
  function c(C, f, h, w) {
    return f === null ||
      ...
      ? ((f = Kn(h, C.mode, w)), (f.return = C), f)
      : ((f = l(f, h.children || [])), (f.return = C), f);
  }
  function m(C, f, h, w, j) {
    return f === null || f.tag !== 7
      ? ((f = T2(h, C.mode, w, j)), (f.return = C), f)
      : ((f = l(f, h)), (f.return = C), f);
  }
  function d(C, f, h) {
    if ((typeof f == "string" && f !== "") || typeof f == "number")
      return (f = Gn("" + f, C.mode, h)), (f.return = C), f;
    if (typeof f == "object" && f !== null) {
      switch (f.$$typeof) {
        case At:
          return (
            (h = r4(f.type, f.key, f.props, null, C.mode, h)),
            (h.ref = O3(C, null, f)),
            (h.return = C),
            h
          );
        case H2:
          return (f = Kn(f, C.mode, h)), (f.return = C), f;
        case Ge:
          var w = f._init;
          return d(C, w(f._payload), h);
      }
      if (V3(f) || Z3(f))
        return (f = T2(f, C.mode, h, null)), (f.return = C), f;
      Dt(C, f);
    }
    return null;
  }
  function p(C, f, h, w) {
    ...
    if ((typeof h == "string" && h !== "") || typeof h == "number")
      return j !== null ? null : u(C, f, "" + h, w);
    if (typeof h == "object" && h !== null) {
      switch (h.$$typeof) {
        case At:
          return h.key === j ? a(C, f, h, w) : null;
        case H2:
          return h.key === j ? c(C, f, h, w) : null;
        case Ge:
          return (j = h._init), p(C, f, j(h._payload), w);
      }
      if (V3(h) || Z3(h)) return j !== null ? null : m(C, f, h, w, null);
      Dt(C, h);
    }
    return null;
  }
  function v(C, f, h, w, j) {
    if ((typeof w == "string" && w !== "") || typeof w == "number")
      return (C = C.get(h) || null), u(f, C, "" + w, j);
    if (typeof w == "object" && w !== null) {
      switch (w.$$typeof) {
        case At:
          return (C = C.get(w.key === null ? h : w.key) || null), a(f, C, w, j);
        case H2:
          return (C = C.get(w.key === null ? h : w.key) || null), c(f, C, w, j);
        case Ge:
          var S = w._init;
          return v(C, f, h, S(w._payload), j);
      }
      if (V3(w) || Z3(w)) return (C = C.get(h) || null), m(f, C, w, j, null);
      Dt(f, w);
    }
    return null;
  }
  function y(C, f, h, w) {
    for (
      var j = null, S = null, M = f, E = (f = 0), z = null;
      M !== null && E < h.length;
      E++
    ) {
      M.index > E ? ((z = M), (M = null)) : (z = M.sibling);
      var P = p(C, M, h[E], w);
      if (P === null) {
        M === null && (M = z);
        break;
      }
      e && M && P.alternate === null && t(C, M),
        (f = s(P, f, E)),
        S === null ? (j = P) : (S.sibling = P),
        (S = P),
        (M = z);
    }
    if (E === h.length) return n(C, M), l1 && M2(C, E), j;
    if (M === null) {
      for (; E < h.length; E++)
        (M = d(C, h[E], w)),
          M !== null &&
            ((f = s(M, f, E)), S === null ? (j = M) : (S.sibling = M), (S = M));
      return l1 && M2(C, E), j;
    }
    for (M = r(C, M); E < h.length; E++)
      (z = v(M, C, E, h[E], w)),
        z !== null &&
          (e && z.alternate !== null && M.delete(z.key === null ? E : z.key),
          (f = s(z, f, E)),
          S === null ? (j = z) : (S.sibling = z),
          (S = z));
    return (
      e &&
  ...
  function x(C, f, h, w) {
    ...
    if (((h = j.call(h)), h == null)) throw Error(_(151));
    for (
      var S = (j = null), M = f, E = (f = 0), z = null, P = h.next();
      M !== null && !P.done;
      E++, P = h.next()
    ) {
      M.index > E ? ((z = M), (M = null)) : (z = M.sibling);
      var W = p(C, M, P.value, w);
      if (W === null) {
        M === null && (M = z);
        break;
      }
      e && M && W.alternate === null && t(C, M),
        (f = s(W, f, E)),
        S === null ? (j = W) : (S.sibling = W),
        (S = W),
        (M = z);
    }
    if (P.done) return n(C, M), l1 && M2(C, E), j;
    if (M === null) {
      for (; !P.done; E++, P = h.next())
        (P = d(C, P.value, w)),
          P !== null &&
            ((f = s(P, f, E)), S === null ? (j = P) : (S.sibling = P), (S = P));
      return l1 && M2(C, E), j;
    }
    for (M = r(C, M); !P.done; E++, P = h.next())
      (P = v(M, C, E, P.value, w)),
        P !== null &&
  ...
  function A(C, f, h, w) {
    if (
      ...
      switch (h.$$typeof) {
        case At:
          e: {
            for (var j = h.key, S = f; S !== null; ) {
              if (S.key === j) {
                if (((j = h.type), j === Y2)) {
                  if (S.tag === 7) {
                    n(C, S.sibling),
                      (f = l(S, h.props.children)),
                      (f.return = C),
                      (C = f);
                    break e;
                  }
            ...
            h.type === Y2
              ? ((f = T2(h.props.children, C.mode, w, h.key)),
                (f.return = C),
                (C = f))
              : ((w = r4(h.type, h.key, h.props, null, C.mode, w)),
                (w.ref = O3(C, f, h)),
        ...
        case H2:
          e: {
            ...
            (f = Kn(h, C.mode, w)), (f.return = C), (C = f);
          }
          return o(C);
        case Ge:
          return (S = h._init), A(C, f, S(h._payload), w);
      }
      if (V3(h)) return y(C, f, h, w);
      if (Z3(h)) return x(C, f, h, w);
      Dt(C, h);
    }
    return (typeof h == "string" && h !== "") || typeof h == "number"
      ? ((h = "" + h),
        f !== null && f.tag === 6
          ...
          : (n(C, f), (f = Gn(h, C.mode, w)), (f.return = C), (C = f)),
        o(C))
      : n(C, f);
  }
  return A;
...
var v3 = Z0(!0),
  ...
  ft = y2(jt);
function Z2(e) {
  if (e === jt) throw Error(_(174));
  return e;
}
function Fr(e, t) {
  switch ((b(ft, t), b(ct, e), b(Ee, jt), (e = t.nodeType), e)) {
    case 9:
    case 11:
...
function $r(e, t, n, r, l, s) {
  if (
    ...
    s = 0;
    do {
      if (((G3 = !1), (dt = 0), 25 <= s)) throw Error(_(301));
      (s += 1),
        (w1 = m1 = null),
        (t.updateQueue = null),
        (bt.current = Ci),
...
function Se() {
  ...
  return w1 === null ? (i1.memoizedState = w1 = e) : (w1 = w1.next = e), w1;
}
function ce() {
  if (m1 === null) {
    var e = i1.alternate;
  ...
  var t = w1 === null ? i1.memoizedState : w1.next;
  if (t !== null) (w1 = t), (m1 = e);
  else {
    ...
    (m1 = e),
      ...
      w1 === null ? (i1.memoizedState = w1 = e) : (w1 = w1.next = e);
  }
  return w1;
}
function Ct(e, t) {
...
function Qn(e) {
  ...
  if (((e = n.interleaved), e !== null)) {
    l = e;
    do (s = l.lane), (i1.lanes |= s), (z2 |= s), (l = l.next);
    while (l !== e);
...
function R0(e, t, n, r) {
  (t.value = n), (t.getSnapshot = r), z0(t) && D0(e);
}
function I0(e, t, n) {
  return n(function () {
    z0(t) && D0(e);
...
function m9(e) {
  ...
  return (
    ...
    (t.queue = e),
    (e = e.dispatch = ci.bind(null, i1, e)),
    [t.memoizedState, e]
  );
}
function pt(e, t, n, r) {
...
function H4(e, t, n, r) {
  ...
  (i1.flags |= e), (l.memoizedState = pt(1 | t, n, s, r));
}
function v9(e, t) {
...
function H0(e, t, n) {
  return I2 & 21
    ? (we(n, t) || ((n = G8()), (i1.lanes |= n), (z2 |= n), (e.baseState = !0)),
      t)
...
function ci(e, t, n) {
  ...
  if (X0(e)) G0(t, l);
    ...
    (n = L0(e, t, l, r)),
      n !== null && ((l = z1()), xe(n, e, r, l), K0(n, t, r));
  }
}
function X0(e) {
  var t = e.alternate;
  return e === i1 || (t !== null && t === i1);
}
function G0(e, t) {
  G3 = k4 = !0;
  var n = e.pending;
...
var j4 = {
    ...
    useReducer: function (e, t, n) {
      ...
      return (
        ...
        (r.queue = e),
        (e = e.dispatch = ai.bind(null, i1, e)),
        [r.memoizedState, e]
      );
    },
    useRef: function (e) {
    ...
    useTransition: function () {
      var e = m9(!1),
        t = e[0];
      return (e = ui.bind(null, e[1])), (Se().memoizedState = e), [t, e];
    },
    ...
    useSyncExternalStore: function (e, t, n) {
      ...
      if (l1) {
        ...
        if (((n = t()), k1 === null)) throw Error(_(349));
        I2 & 30 || O0(r, t, n);
      }
      l.memoizedState = n;
  ...
  return (
    ...
    e !== null && !$1
      ? ((t.updateQueue = e.updateQueue),
        ...
        (e.lanes &= ~l),
        $e(e, t, l))
      : (l1 && n && Nr(t), (t.flags |= 1), R1(e, t, r, l), t.child)
  );
}
  ...
  return (
    ...
    e !== null && !$1
      ? ((t.updateQueue = e.updateQueue),
        ...
        (e.lanes &= ~l),
        $e(e, t, l))
      : (l1 && r && Nr(t), (t.flags |= 1), R1(e, t, n, l), t.child)
  );
}
function j9(e, t, n, r, l) {
  ...
  if ((a3(t, l), t.stateNode === null))
    ...
    (o.state = p),
      x4(t, r, o, l),
      (a = t.memoizedState),
      u !== r || p !== a || W1.current || Ke
        ? (typeof m == "function" && ($5(t, n, m, r), (a = t.memoizedState)),
          (u = Ke || C9(t, n, u, r, p, a, c))
            ? (d ||
    ...
    u !== d || p !== y || W1.current || Ke
      ? (typeof v == "function" && ($5(t, n, v, r), (y = t.memoizedState)),
        (c = Ke || C9(t, n, c, r, p, y, a) || !1)
          ? (m ||
...
function mi(e, t, n, r, l, s, o) {
  ...
  if (l.data === "$!") {
    ...
    return (r = u), (s = Error(_(419))), (r = Yn(s, r, void 0)), Ft(e, t, o, r);
  }
  if (((u = (o & e.childLanes) !== 0), $1 || u)) {
    if (((r = k1), r !== null)) {
      ...
      (l = l & (r.suspendedLanes | o) ? 0 : l),
        l !== 0 &&
          l !== s.retryLane &&
          ((s.retryLane = l), Be(e, l), xe(r, e, l, -1));
    }
    return Jr(), (r = Yn(Error(_(421)))), Ft(e, t, o, r);
  }
  return l.data === "$?"
    ? ((t.flags |= 128),
      (t.child = e.child),
...
function l7(e, t, n) {
  var r = t.pendingProps,
    l = r.revealOrder,
    s = r.tail;
  if ((R1(e, t, r.children, n), (r = s1.current), r & 2))
    (r = (r & 1) | 2), (t.flags |= 128);
  else {
  ...
  if ((b(s1, r), !(t.mode & 1))) t.memoizedState = null;
  else
    switch (l) {
      case "forwards":
...
function vi(e, t, n) {
  switch (t.tag) {
    ...
    case 10:
      ...
      b(y4, r._currentValue), (r._currentValue = l);
      break;
    case 13:
      if (((r = t.memoizedState), r !== null))
        return r.dehydrated !== null
          ? (b(s1, s1.current & 1), (t.flags |= 128), null)
  ...
  switch ((Tr(t), t.tag)) {
    ...
    case 5:
      ...
      if (((n = t.type), e !== null && t.stateNode != null))
        ...
        if (((e = Z2(Ee.current)), zt(t))) {
          (r = t.stateNode), (n = t.type);
          var s = t.memoizedProps;
          switch (((r[Ae] = t), (r[at] = s), (e = (t.mode & 1) !== 0), n)) {
            case "dialog":
            ...
            case "video":
            case "audio":
              for (l = 0; l < B3.length; l++) J(B3[l], r);
              break;
            case "source":
              J("error", r);
              break;
          ...
          e: {
            switch (((o = M5(n, r)), n)) {
              ...
              case "video":
              case "audio":
                for (l = 0; l < B3.length; l++) J(B3[l], e);
                l = r;
                break;
              case "source":
                J("error", e), (l = r);
    ...
    case 6:
      if (e && t.stateNode != null) o7(e, t, e.memoizedProps, r);
        ...
        if (((n = Z2(ft.current)), Z2(Ee.current), zt(t))) {
          if (
            ((r = t.stateNode),
            (n = t.memoizedProps),
            (r[Ae] = t),
            (s = r.nodeValue !== n) && ((e = q1), e !== null))
          )
            switch (e.tag) {
              case 3:
                It(r.nodeValue, n, (e.mode & 1) !== 0);
                break;
              case 5:
    ...
    case 13:
      if (
        ...
        if (l1 && K1 !== null && t.mode & 1 && !(t.flags & 128))
        ...
        else if (((s = zt(t)), r !== null && r.dehydrated !== null)) {
          if (e === null) {
          ...
          N1(t), (s = !1);
        } else me !== null && (lr(me), (me = null)), (s = !0);
      ...
      return t.flags & 128
        ...
        : ((r = r !== null),
          r !== (e !== null && e.memoizedState !== null) &&
            ...
            ((t.child.flags |= 8192),
            t.mode & 1 &&
              (e === null || s1.current & 1 ? v1 === 0 && (v1 = 3) : Jr())),
    ...
    case 10:
      return Ir(t.type._context), N1(t), null;
    case 17:
      return Q1(t.type) && p4(), N1(t), null;
    case 19:
      if ((e1(s1), (s = t.memoizedState), s === null)) return N1(t), null;
              ...
              if (((o = w4(e)), o !== null)) {
                for (
                  ...
                  (s = n),
                    ...
                    (n = n.sibling);
                return b(s1, (s1.current & 1) | 2), t.child;
              }
              e = e.sibling;
            }
          s.tail !== null &&
        ...
        if (!r)
          if (((e = w4(o)), e !== null)) {
            if (
              ...
              R3(s, !0),
              s.tail === null && s.tailMode === "hidden" && !o.alternate && !l1)
            )
              return N1(t), null;
          } else
            2 * d1() - s.renderingStartTime > x3 &&
              n !== 1073741824 &&
              ((t.flags |= 128), (r = !0), R3(s, !1), (t.lanes = 4194304));
        s.isBackwards
...
function gi(e, t) {
  switch ((Tr(t), t.tag)) {
    ...
    case 13:
      if (
        (e1(s1), (e = t.memoizedState), e !== null && e.dehydrated !== null)
      ) {
    ...
    case 4:
      return y3(), null;
    case 10:
      return Ir(t.type._context), null;
    case 22:
    case 23:
      return br(), null;
    case 24:
...
function wi(e, t) {
  ...
  for (R5 = { focusedElem: e, selectionRange: n }, c4 = !1, R = t; R !== null; )
...
function u7(e) {
  ...
  t !== null && ((e.alternate = null), u7(t)),
    ...
    e.tag === 5 &&
      ((t = e.stateNode),
      t !== null &&
        (delete t[Ae], delete t[at], delete t[D5], delete t[ri], delete t[li])),
    (e.stateNode = null),
    (e.return = null),
    (e.dependencies = null),
        ...
        e: for (; u !== null; ) {
          switch (u.tag) {
            case 5:
              ...
              break e;
            case 3:
              (S1 = u.stateNode.containerInfo), (he = !0);
              break e;
            case 4:
              (S1 = u.stateNode.containerInfo), (he = !0);
              break e;
...
function f7(e, t) {
  ...
  switch (e.tag) {
    ...
    case 15:
      ...
      break;
    case 1:
      Ce(t, e), je(e), r & 512 && n !== null && n3(n, n.return);
      break;
    case 5:
      if (
        (Ce(t, e),
    ...
    case 3:
      if (
        (Ce(t, e), je(e), r & 4 && n !== null && n.memoizedState.isDehydrated)
      )
        try {
          lt(t.containerInfo);
        } catch (x) {
          ...
          for (R = l; R !== null; )
            (o = R),
              ...
              o.tag === 22 && o.memoizedState !== null
                ...
                ? ((a.return = o), (R = a))
                : N9(l);
        for (; s !== null; ) (R = s), d7(s), (s = s.sibling);
        (R = l), (Vt = u), (P1 = c);
      }
      Z9(e);
    } else
      l.subtreeFlags & 8772 && s !== null ? ((s.return = l), (R = s)) : Z9(e);
  }
}
function Z9(e) {
  for (; R !== null; ) {
...
function xe(e, t, n, r) {
  if (50 < b3) throw ((b3 = 0), (nr = null), Error(_(185)));
  xt(e, n, r),
    (!(H & 2) || e !== k1) &&
      (e === k1 && (!(H & 2) && (X4 |= n), v1 === 4 && be(e, A1)),
      H1(e, r),
      n === 1 && H === 0 && !(t.mode & 1) && ((x3 = d1() + 500), W4 && g2()));
}
function H1(e, t) {
  var n = e.callbackNode;
  is(e, t);
  var r = a4(e, e === k1 ? A1 : 0);
  if (r === 0)
    n !== null && V6(n), (e.callbackNode = null), (e.callbackPriority = 0);
...
function C7(e, t) {
  ...
  if (r & 30 || r & e.expiredLanes || t) t = A4(e, r);
    ...
    H |= 2;
    var s = h7();
    (k1 !== e || A1 !== t) && ((Oe = null), (x3 = d1() + 500), N2(e, t));
    do
      try {
        Si();
        break;
    ...
    Rr(),
      (M4.current = s),
      (H = l),
      h1 !== null ? (t = 0) : ((k1 = null), (A1 = 0), (t = v1));
  }
  if (t !== 0) {
    if (
      (t === 2 && ((l = Z5(e)), l !== 0 && ((r = l), (t = rr(e, l)))), t === 1)
    )
      throw ((n = ht), N2(e, 0), be(e, r), H1(e, d1()), n);
    if (t === 6) be(e, r);
    else {
      if (
      ...
      switch (((e.finishedWork = l), (e.finishedLanes = r), t)) {
        ...
        case 3:
          if (
            (be(e, r), (r & 130023424) === r && ((t = Kr + 500 - d1()), 10 < t))
          ) {
            if (a4(e, 0) !== 0) break;
            if (((l = e.suspendedLanes), (l & r) !== r)) {
              z1(), (e.pingedLanes |= e.suspendedLanes & l);
              break;
            }
            e.timeoutHandle = z5(L2.bind(null, e, B1, Oe), t);
            break;
          }
          L2(e, B1, Oe);
          break;
        case 4:
          ...
          if (
            ...
            e.timeoutHandle = z5(L2.bind(null, e, B1, Oe), r);
            break;
          }
          L2(e, B1, Oe);
          break;
...
function T9(e) {
  ...
  if (n === 1) throw ((n = ht), N2(e, 0), be(e, t), H1(e, d1()), n);
...
function qr(e, t) {
  ...
  try {
    ...
    (H = n), H === 0 && ((x3 = d1() + 500), W4 && g2());
  }
}
function D2(e) {
  t2 !== null && t2.tag === 0 && !(H & 6) && c3();
  var t = H;
  H |= 1;
  var n = ue.transition,
    r = X;
  try {
    if (((ue.transition = null), (X = 1), e)) return e();
  } finally {
    (X = r), (ue.transition = n), (H = t), !(H & 6) && g2();
  }
}
function br() {
  (G1 = r3.current), e1(r3);
...
function N2(e, t) {
  ...
  if ((n !== -1 && ((e.timeoutHandle = -1), ei(n)), h1 !== null))
  ...
  do {
    ...
    try {
      if ((Rr(), (bt.current = j4), k4)) {
        for (var r = i1.memoizedState; r !== null; ) {
          var l = r.queue;
...
function Jr() {
  (v1 === 0 || v1 === 3 || v1 === 2) && (v1 = 4),
    k1 === null || (!(z2 & 268435455) && !(X4 & 268435455)) || be(k1, A1);
}
function A4(e, t) {
  var n = H;
  H |= 2;
  var r = h7();
  (k1 !== e || A1 !== t) && ((Oe = null), N2(e, t));
  do
    try {
      Li();
      break;
  ...
  while (1);
  if ((Rr(), (H = n), (M4.current = r), h1 !== null)) throw Error(_(261));
  return (k1 = null), (A1 = 0), v1;
}
function Li() {
  for (; h1 !== null; ) m7(h1);
}
...
function L2(e, t, n) {
  var r = X,
    l = ue.transition;
  try {
    (ue.transition = null), (X = 1), Ai(e, t, n, r);
  } finally {
    (ue.transition = l), (X = r);
  }
  return null;
...
function c3() {
  if (t2 !== null) {
    var e = K8(S4),
      ...
      n = X;
    try {
      if (((ue.transition = null), (X = 16 > e ? 16 : e), t2 === null))
        var r = !1;
      else {
        if (((e = t2), (t2 = null), (S4 = 0), H & 6)) throw Error(_(331));
        var l = H;
        ...
        if (
          ((H = l), g2(), Ze && typeof Ze.onPostCommitFiberRoot == "function")
        )
          try {
...
g7 = function (e, t, n) {
  ...
  else ($1 = !1), l1 && t.flags & 1048576 && k0(t, v4, t.index);
  switch (((t.lanes = 0), t.tag)) {
      ...
      return (
        ...
        l.$$typeof === void 0
          ? ((t.tag = 1),
            ...
            W5(t, r, e, n),
            (t = Y5(null, t, r, !0, s, n)))
          : ((t.tag = 0), l1 && s && Nr(t), R1(null, t, l, n), (t = t.child)),
        t
      );
    case 16:
      r = t.elementType;
    ...
    case 5:
      return (
        ...
        (o = l.children),
        I5(r, l) ? (o = null) : s !== null && I5(r, s) && (t.flags |= 32),
        t7(e, t),
        R1(e, t, o, n),
        t.child
      );
    case 6:
      return e === null && U5(t), null;
    case 13:
      return r7(e, t, n);
    case 4:
      return (
...
function r4(e, t, n, r, l, s) {
  ...
  if (((r = e), typeof e == "function")) e6(e) && (o = 1);
    ...
    e: switch (e) {
      ...
      case p5:
        return (
          (e = oe(12, n, t, l | 2)), (e.elementType = p5), (e.lanes = s), e
        );
      case h5:
        return (e = oe(13, n, t, l)), (e.elementType = h5), (e.lanes = s), e;
      case m5:
        return (e = oe(19, n, t, l)), (e.elementType = m5), (e.lanes = s), e;
      case Z8:
        return G4(n, l, s, t);
      default:
  ...
  return (
    (t = oe(o, n, t, l)), (t.elementType = e), (t.type = r), (t.lanes = s), t
  );
}
function T2(e, t, n, r) {
...
function w7(e) {
  ...
  e = e._reactInternals;
  e: {
    if (U2(e) !== e || e.tag !== 1) throw Error(_(170));
    var t = e;
    do {
      switch (t.tag) {
        case 3:
  ...
  switch (e.tag) {
    case 3:
      ...
      if (t.current.memoizedState.isDehydrated) {
        var n = U3(t.pendingLanes);
        n !== 0 &&
          (jr(t, n | 1), H1(t, d1()), !(H & 6) && ((x3 = d1() + 500), g2()));
      }
      break;
    case 13:
      D2(function () {
...
V8 = qr;
U8 = D2;
var zi = { usingClientEntryPoint: !1, Events: [kt, q2, $4, D8, F8, qr] },
  I3 = {
  ...
  Di = {
    bundleType: I3.bundleType,
    version: I3.version,
    rendererPackageName: I3.rendererPackageName,
    rendererConfig: I3.rendererConfig,
    ...
    findFiberByHostInstance: I3.findFiberByHostInstance || Ri,
...
if (typeof __REACT_DEVTOOLS_GLOBAL_HOOK__ < "u") {
  ...
  if (!Bt.isDisabled && Bt.supportsFiber)
    try {
      (F4 = Bt.inject(Di)), (Ze = Bt);
    } catch {}
}
ee.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED = zi;
...
var L7 = k8.exports,
  I9 = L7;
(d5.createRoot = I9.createRoot), (d5.hydrateRoot = I9.hydrateRoot);
var S7 = { exports: {} },
  A7 = {};
/**
 * @license React
...
var Vi = typeof Object.is == "function" ? Object.is : Fi,
  Ui = w3.useState,
  Bi = w3.useEffect,
...
function Qi(e, t) {
  var n = t(),
    r = Ui({ inst: { value: n, getSnapshot: t } }),
    l = r[0].inst,
    s = r[1];
  return (
    $i(
  ...
  s = to(
    function () {
      function a(v) {
        ...
        if (((y = d), qi(m, v))) return y;
        var x = r(v);
        return l !== void 0 && l(y, x) ? y : ((m = v), (d = x));
      }
      var c = !1,
        m,
        d,
...
const so = (e) => (E7 = e),
  io = () => E7,
  z9 = Symbol.for("react-redux-context"),
  D9 = typeof globalThis < "u" ? globalThis : {};
function oo() {
  var e;
  if (!N.createContext) return {};
  const t = (e = D9[z9]) != null ? e : (D9[z9] = new Map());
...
function fo(e = h2) {
  ...
  return function (r, l = {}) {
    ...
    const v = N.useCallback(
      ...
      y = T7(c.addNestedSub, a.getState, m || a.getState, v, s);
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */ var j1 = typeof Symbol == "function" && Symbol.for,
  i6 = j1 ? Symbol.for("react.element") : 60103,
  o6 = j1 ? Symbol.for("react.portal") : 60106,
  tn = j1 ? Symbol.for("react.fragment") : 60107,
  nn = j1 ? Symbol.for("react.strict_mode") : 60108,
  rn = j1 ? Symbol.for("react.profiler") : 60114,
  ln = j1 ? Symbol.for("react.provider") : 60109,
  sn = j1 ? Symbol.for("react.context") : 60110,
  u6 = j1 ? Symbol.for("react.async_mode") : 60111,
  on = j1 ? Symbol.for("react.concurrent_mode") : 60111,
  un = j1 ? Symbol.for("react.forward_ref") : 60112,
  an = j1 ? Symbol.for("react.suspense") : 60113,
  po = j1 ? Symbol.for("react.suspense_list") : 60120,
  cn = j1 ? Symbol.for("react.memo") : 60115,
  fn = j1 ? Symbol.for("react.lazy") : 60116,
  ho = j1 ? Symbol.for("react.block") : 60121,
  mo = j1 ? Symbol.for("react.fundamental") : 60117,
  vo = j1 ? Symbol.for("react.responder") : 60118,
  yo = j1 ? Symbol.for("react.scope") : 60119;
function ne(e) {
  if (typeof e == "object" && e !== null) {
    var t = e.$$typeof;
    switch (t) {
 ...
 */ var a6 = Symbol.for("react.element"),
  ...
  z7;
z7 = Symbol.for("react.module.reference");
function fe(e) {
  if (typeof e == "object" && e !== null) {
    var t = e.$$typeof;
    switch (t) {
...
const So =
    ...
    typeof window.document < "u" &&
    typeof window.document.createElement < "u",
  Ao = So ? N.useLayoutEffect : N.useEffect;
function _o({
  store: e,
  context: t,
  children: n,
  ...
  const a = t || h2;
  return N.createElement(a.Provider, { value: o }, n);
}
function D7(e = h2) {
  const t = e === h2 ? N7 : s6(e);
  return function () {
...
function Fo() {
  ...
  function n(s) {
    for (var o = s.t, u = s.k, a = d3(u), c = a.length - 1; c >= 0; c--) {
      ...
      if (m !== r1) {
        var d = o[m];
        if (d === void 0 && !f3(o, m)) return !0;
        var p = u[m],
          v = p && p[r1];
        if (v ? v.t !== d : !U7(p, d)) return !0;
      }
    }
    var y = !!o[r1];
    return a.length !== d3(o).length + (y ? 0 : 1);
  }
  function r(s) {
    var o = s.k;
  ...
  Io("ES5", {
    J: function (s, o) {
      var u = Array.isArray(s),
        a = (function (m, d) {
          if (m) {
            for (var p = Array(d.length), v = 0; v < d.length; v++)
              Object.defineProperty(p, "" + v, e(v, !0));
            return p;
          }
          var y = $7(d);
          delete y[r1];
          for (var x = d3(y), A = 0; A < x.length; A++) {
            var C = x[A];
            y[C] = e(C, m || !!y[C].enumerable);
          }
      ...
      return Object.defineProperty(a, r1, { value: c, writable: !0 }), a;
    },
    S: function (s, o, u) {
      u
        ? m2(o) && o[r1].A === s && t(s.p)
              ...
              if (c && typeof c == "object") {
                ...
                if (m) {
                  ...
                  if (y === 4)
                    ...
                    if ((r(m) && (Je(m), (v.length = !0)), p.length < d.length))
                      for (var x = p.length; x < d.length; x++) v[x] = !1;
                    else for (var A = d.length; A < p.length; A++) v[A] = !0;
                    for (
                      var C = Math.min(p.length, d.length), f = 0;
                      f < C;
                      f++
                    )
...
var W9,
  ...
  vt = {
    ...
    set: function (e, t, n) {
      ...
      if (!e.P) {
        var l = e5(S2(e), t),
          s = l == null ? void 0 : l[r1];
        if (s && s.t === n) return (e.o[t] = n), (e.R[t] = !1), !0;
        if (U7(n, l) && (n !== void 0 || f3(e.t, t))) return !0;
        t5(e), Je(e);
      }
      return (
...
var $o = (function () {
          ...
          if (typeof l == "function" && typeof s != "function") {
            ...
            return function (x) {
              ...
              return a.produce(x, function (w) {
                var j;
                return (j = s).call.apply(j, [A, w].concat(f));
              });
            };
          }
          var c;
          if (
            (typeof s != "function" && ve(6),
    ...
    return (
      (t.createDraft = function (n) {
        We(n) || ve(8), m2(n) && (n = Do(n));
        var r = V9(this),
          l = or(this, n, void 0);
        return (l[r1].C = !0), ir(r), l;
      }),
  ...
  J1 = new $o(),
  W7 = J1.produce;
J1.produceWithPatches.bind(J1);
J1.setAutoFreeze.bind(J1);
J1.setUseProxies.bind(J1);
J1.applyPatches.bind(J1);
J1.createDraft.bind(J1);
J1.finishDraft.bind(J1);
function yt(e) {
...
function Q7(e, t, n) {
  ...
  function d(x) {
    if (typeof x != "function") throw new Error(T1(4));
  ...
  function p(x) {
    if (!Yo(x)) throw new Error(T1(7));
    if (typeof x.type > "u") throw new Error(T1(8));
    ...
    for (var A = (o = u), C = 0; C < A.length; C++) {
      var f = A[C];
      f();
    }
    return x;
  ...
  function v(x) {
    if (typeof x != "function") throw new Error(T1(10));
    (l = x), p({ type: T4.REPLACE });
  }
  function y() {
    var x,
      A = d;
  ...
  return (
    p({ type: T4.INIT }),
    (r = { dispatch: p, subscribe: d, getState: m, replaceReducer: v }),
    (r[G9] = y),
    r
  );
}
...
function H7(e) {
  ...
  return function (a, c) {
    ...
    for (var m = !1, d = {}, p = 0; p < s.length; p++) {
      var v = s[p],
        y = n[v],
        x = a[v],
        A = y(x, c);
    ...
    return (m = m || s.length !== Object.keys(a).length), m ? d : a;
  };
}
function P4() {
...
function fu(e) {
  ...
  var x = Go.apply(void 0, y),
    A = P4;
  a && (A = ru(f2({ trace: !cu }, typeof a == "object" && a)));
  var C = new iu(x),
    f = C;
  Array.isArray(p) ? (f = k3([x], p)) : typeof p == "function" && (f = p(C));
...
function kn(e) {
  ...
  l.forEach(function (m) {
    var d = r[m],
      ...
      v,
      y;
    "reducer" in d ? ((v = d.reducer), (y = d.prepare)) : (v = d),
      (s[m] = v),
      (o[p] = v),
      (u[m] = y ? d2(p, y) : d2(p));
  });
  function a() {
    var m =
      ...
      A = x === void 0 ? void 0 : x,
      C = f2(f2({}, p), o);
    return Cu(n, function (f) {
      for (var h in C) f.addCase(h, C[h]);
      for (var w = 0, j = y; w < j.length; w++) {
        var S = j[w];
        f.addMatcher(S.matcher, S.reducer);
      }
...
(function () {
  function e(t, n, r) {
    var l = d2(t + "/fulfilled", function (c, m, d, p) {
        return {
          payload: c,
          meta: r5(f2({}, p || {}), {
            arg: d,
      ...
      o = d2(t + "/rejected", function (c, m, d, p, v) {
        return {
          payload: p,
                      ...
                      Promise.race([
                        ...
                        Promise.resolve(
                          n(c, {
                            ...
                            signal: y.signal,
                            abort: A,
                            rejectWithValue: function (P, W) {
                              return new l5(P, W);
                            },
                            fulfillWithValue: function (P, W) {
                              return new J9(P, W);
                            },
                          })
                        ).then(function (P) {
                          if (P instanceof l5) throw P;
                          return P instanceof J9
                            ? l(P.payload, v, c, P.meta)
                            : l(P, v, c);
                        }),
                      ]),
                    ]
...
const Ru = "_task__info_15avx_1",
  Iu = "_task_15avx_1",
  zu = "_list_15avx_95",
  x2 = { task__info: Ru, task: Iu, list: zu },
...
const Uu = "_taskInfo_1xio4_1",
  Bu = "_task_1xio4_1",
  $u = "_taskAnswer_1xio4_29",
  Wu = "_danger_1xio4_69",
  Qu = "_cart_1xio4_75",
  $t = { taskInfo: Uu, task: Bu, taskAnswer: $u, danger: Wu, cart: Qu },
...
function Yu(e) {
  ...
  const p = (x) => {
      ...
      (d.style.left = "auto"),
        ...
        (d.style.position = "absolute");
      let A = d.offsetLeft - d.offsetWidth;
      A < 0 && (A = d.offsetLeft);
      const C = d.offsetTop;
      (d.style.zIndex = "1"),
        (d.style.left = A + "px"),
    ...
    v = (x) => {
      ...
      if (d) {
        ...
        const C = A.clientY - o - d.offsetHeight / 2,
          f = A.clientX - s - d.offsetWidth / 2;
        if (
          (C > 14 && C < 112 && (d.style.top = C + "px"),
          f > 0 && f < 270 && (d.style.left = f + "px"),
          C > 14 && C < 140 && f > 90 && f < 170)
        ) {
          ...
          h &&
            ...
            (a(
              u.map(
                (w, j) => (j + "" === h ? (w.check = !0) : (w.check = !1), w)
              )
            ),
            t(Y(h === "2" ? "true" : "false")),
            m(h)),
            n(!0),
            h === "1" && (d.style.fontSize = "20px"),
            (d.style.color = "#008C95"),
            (d.style.top = "50%"),
            (d.style.left = "50%"),
            (d.style.transform = "translateX(-50%) translateY(-50%)");
        } else (d.style.color = "#fff"), (d.style.fontSize = "25px");
      }
    },
    y = () => {
      if (
        ((document.body.style.overflow = "auto"),
        d && d.style.top !== "50%" && d.style.left !== "50%")
      ) {
                    ...
                    style: {
                      color: x.check
                        ? r
                          ...
                          : "#008C95"
                        : "#fff",
                      position: x.check ? "absolute" : "static",
...
var y1 = (e) => !I1(e) && !Array.isArray(e) && nl(e) && !l3(e),
  Xu = (e) =>
...
var Lt = (e) => (Array.isArray(e) ? e.filter(Boolean) : []),
  ...
  D = (e, t, n) => {
    if (!t || !y1(e)) return n;
    const r = Lt(t.split(/[,[\].]+?/)).reduce((l, s) => (I1(l) ? l : l[s]), e);
...
var bu = (e, t, n, r = !0) => {
  ...
  Ju = (e, t, n, r) => {
    ...
    return (
      ...
      Object.keys(s).find((o) => t[o] === (!r || ye.all))
    );
  },
...
function n1(e, t, n) {
  ...
  for (; ++r < s; ) {
    ...
    if (r !== o) {
      const c = e[u];
      a = y1(c) || Array.isArray(c) ? c : isNaN(+l[r + 1]) ? {} : [];
    }
    (e[u] = a), (e = e[u]);
  }
  return e;
...
var Q2 = (e) => (y1(e) && !R4(e) ? e : { value: e, message: "" }),
  u8 = async (e, t, n, r, l) => {
    const {
        ref: s,
        refs: o,
    ...
    const h = o ? o[0] : s,
      w = (U) => {
        r &&
          h.reportValidity &&
          (h.setCustomValidity(C3(U) ? "" : U || ""), h.reportValidity());
      },
      j = {},
      S = w6(s),
      M = Mt(s),
      E = S || M,
      z =
        ((x || x6(s)) && p1(s.value) && p1(f)) ||
        (O4(s) && s.value === "") ||
        f === "" ||
        (Array.isArray(f) && !f.length),
      P = na.bind(null, y, n, j),
      W = (U, $, q, g1 = Te.maxLength, x1 = Te.minLength) => {
        const Z1 = U ? $ : q;
        j[y] = {
          type: U ? g1 : x1,
          message: Z1,
    ...
    if (!z && (!I1(m) || !I1(d))) {
      ...
      const q = Q2(d),
        g1 = Q2(m);
      if (!I1(f) && !isNaN(f)) {
        const x1 = s.valueAsNumber || (f && +f);
        I1(q.value) || (U = x1 > q.value), I1(g1.value) || ($ = x1 < g1.value);
      } else {
        const x1 = s.valueAsDate || new Date(f),
          Z1 = (B) => new Date(new Date().toDateString() + " " + B),
          T = s.type == "time",
          I = s.type == "week";
        _e(q.value) &&
          f &&
      ...
      if ((U || $) && (W(!!U, q.message, g1.message, Te.max, Te.min), !n))
        return w(j[y].message), j;
    }
    if ((a || c) && !z && (_e(f) || (l && Array.isArray(f)))) {
      const U = Q2(a),
        $ = Q2(c),
        q = !I1(U.value) && f.length > +U.value,
        g1 = !I1($.value) && f.length < +$.value;
      if ((q || g1) && (W(q, U.message, $.message), !n))
        return w(j[y].message), j;
    }
    if (p && !z && _e(f)) {
      const { value: U, message: $ } = Q2(p);
      if (
        R4(U) &&
        !f.match(U) &&
        ((j[y] = { type: Te.pattern, message: $, ref: s, ...P(Te.pattern, $) }),
        !n)
      )
        return w($), j;
    }
    if (v) {
      if (n2(v)) {
        const U = await v(f, t),
          $ = o8(U, h);
        if ($ && ((j[y] = { ...$, ...P(Te.validate, $.message) }), !n))
          return w($.message), j;
      } else if (y1(v)) {
        let U = {};
        for (const $ in v) {
          if (!le(U) && !n) break;
          const q = o8(await v[$](f, t), h, $);
          q &&
            ((U = { ...q, ...P($, q.message) }), w(q.message), n && (j[y] = U));
        }
        if (!le(U) && ((j[y] = { ref: h, ...U }), !n)) return j;
      }
    }
    return w(!0), j;
  };
...
function L1(e, t) {
  ...
  return (
    r && delete r[s],
    l !== 0 &&
      ((y1(r) && le(r)) || (Array.isArray(r) && sa(r))) &&
      L1(e, n.slice(0, -1)),
    e
  );
}
  ...
  if (y1(e) || n)
    for (const r in e)
      Array.isArray(e[r]) || (y1(e[r]) && !ol(e[r]))
        ? ((t[r] = Array.isArray(e[r]) ? [] : {}), z4(e[r], t[r]))
        : I1(e[r]) || (t[r] = !0);
  return t;
}
function ul(e, t, n) {
  ...
  if (y1(e) || r)
    for (const l in e)
      Array.isArray(e[l]) || (y1(e[l]) && !ol(e[l]))
        ? p1(t) || I4(n[l])
          ? (n[l] = Array.isArray(e[l]) ? z4(e[l], []) : { ...z4(e[l]) })
          : ul(e[l], I1(t) ? {} : t[l], n[l])
        : (n[l] = !E2(e[l], t[l]));
  return n;
}
var u5 = (e, t) => ul(e, t, z4(t)),
...
function a5(e) {
  ...
  if (!(e.refs ? e.refs.every((n) => n.disabled) : t.disabled))
    return x6(t)
      ...
      : Mt(t)
      ? ll(e.refs).value
      : al(p1(t.value) ? e.ref.value : t.value, e);
}
var oa = (e, t, n, r) => {
    const l = {};
    for (const s of e) {
...
function da(e = {}, t) {
  ...
  const d = {
    ...
    p = { values: i5(), array: i5(), state: i5() },
    v = e.resetOptions && e.resetOptions.keepDirtyValues,
    y = n8(n.mode),
    x = n8(n.reValidateMode),
    A = n.criteriaMode === ye.all,
    C = (g) => (k) => {
      clearTimeout(m), (m = setTimeout(g, k));
    },
    f = async (g) => {
      if (d.isValid || g) {
        const k = n.resolver ? le((await z()).errors) : await W(l, !0);
        k !== r.isValid && p.state.next({ isValid: k });
      }
    },
    h = (g) => d.isValidating && p.state.next({ isValidating: g }),
    w = (g, k = [], L, F, O = !0, Z = !0) => {
      if (F && L) {
        if (((u.action = !0), Z && Array.isArray(D(l, g)))) {
          const V = L(D(l, g), F.argA, F.argB);
          O && n1(l, g, V);
        }
        if (Z && Array.isArray(D(r.errors, g))) {
          const V = L(D(r.errors, g), F.argA, F.argB);
          O && n1(r.errors, g, V), ca(r.errors, g);
        }
        if (d.touchedFields && Z && Array.isArray(D(r.touchedFields, g))) {
          const V = L(D(r.touchedFields, g), F.argA, F.argB);
          O && n1(r.touchedFields, g, V);
        }
        d.dirtyFields && (r.dirtyFields = u5(s, o)),
          p.state.next({
            name: g,
            isDirty: $(g, k),
    ...
    j = (g, k) => {
      n1(r.errors, g, k), p.state.next({ errors: r.errors });
    },
    S = (g, k, L, F) => {
      const O = D(l, g);
      if (O) {
        const Z = D(o, g, p1(L) ? D(s, g) : L);
        p1(Z) || (F && F.defaultChecked) || k
          ? n1(o, g, k ? Z : a5(O._f))
          : x1(g, Z),
          u.mount && f();
      }
    ...
    M = (g, k, L, F, O) => {
      ...
      if (!L || F) {
        d.isDirty &&
          ((V = r.isDirty),
          (r.isDirty = u1.isDirty = $()),
          (Z = V !== u1.isDirty));
        const f1 = E2(D(s, g), k);
        (V = D(r.dirtyFields, g)),
          f1 ? L1(r.dirtyFields, g) : n1(r.dirtyFields, g, !0),
          (u1.dirtyFields = r.dirtyFields),
          (Z = Z || (d.dirtyFields && V !== !f1));
      }
      if (L) {
        const f1 = D(r.touchedFields, g);
        f1 ||
          (n1(r.touchedFields, g, L),
          (u1.touchedFields = r.touchedFields),
          (Z = Z || (d.touchedFields && f1 !== L)));
      }
      return Z && O && p.state.next(u1), Z ? u1 : {};
    },
    E = (g, k, L, F) => {
      const O = D(r.errors, g),
        Z = d.isValid && C3(k) && r.isValid !== k;
      if (
        (e.delayError && L
          ? ((c = C(() => j(g, L))), c(e.delayError))
          : (clearTimeout(m),
            (c = null),
            L ? n1(r.errors, g, L) : L1(r.errors, g)),
        (L ? !E2(O, L) : O) || !le(F) || Z)
      ) {
        const V = {
          ...F,
    ...
    z = async (g) =>
      n.resolver(
        o,
        n.context,
        oa(g || a.mount, l, n.criteriaMode, n.shouldUseNativeValidation)
      ),
    P = async (g) => {
      ...
      if (g)
        for (const L of g) {
          const F = D(k, L);
          F ? n1(r.errors, L, F) : L1(r.errors, L);
        }
      else r.errors = k;
      return k;
    },
    W = async (g, k, L = { valid: !0 }) => {
      for (const F in g) {
        const O = g[F];
        if (O) {
          const { _f: Z, ...V } = O;
          if (Z) {
            const u1 = a.array.has(Z.name),
              f1 = await u8(O, o, A, n.shouldUseNativeValidation && !k, u1);
            if (f1[Z.name] && ((L.valid = !1), k)) break;
            !k &&
              (D(f1, Z.name)
                ? u1
                  ? ra(r.errors, f1, Z.name)
    ...
    U = () => {
      for (const g of a.unMount) {
        const k = D(l, g);
        k &&
          (k._f.refs ? k._f.refs.every((L) => !o5(L)) : !o5(k._f.ref)) &&
          de(g);
      }
      a.unMount = new Set();
    },
    $ = (g, k) => (g && k && n1(o, g, k), !E2(t1(), s)),
    q = (g, k, L) =>
      ta(g, a, { ...(u.mount ? o : p1(k) ? s : _e(g) ? { [g]: k } : k) }, L, k),
    g1 = (g) =>
      Lt(D(u.mount ? o : s, g, e.shouldUnregister ? D(s, g, []) : [])),
    x1 = (g, k, L = {}) => {
      const F = D(l, g);
      let O = k;
      if (F) {
        const Z = F._f;
        Z &&
          (!Z.disabled && n1(o, g, al(k, Z)),
          (O = O4(Z.ref) && I1(k) ? "" : k),
          il(Z.ref)
            ? [...Z.ref.options].forEach(
                (V) => (V.selected = O.includes(V.value))
              )
            : Z.refs
            ? Mt(Z.ref)
              ? Z.refs.length > 1
                ? Z.refs.forEach(
                    (V) =>
                      ...
                      (V.checked = Array.isArray(O)
                        ? !!O.find((u1) => u1 === V.value)
                        : O === V.value)
                  )
                : Z.refs[0] && (Z.refs[0].checked = !!O)
              : Z.refs.forEach((V) => (V.checked = V.value === O))
            : x6(Z.ref)
            ? (Z.ref.value = "")
            : ((Z.ref.value = O),
              Z.ref.type || p.values.next({ name: g, values: { ...o } })));
      }
      (L.shouldDirty || L.shouldTouch) &&
        M(g, O, L.shouldTouch, L.shouldDirty, !0),
        L.shouldValidate && B(g);
    },
    Z1 = (g, k, L) => {
      for (const F in k) {
        const O = k[F],
          Z = `${g}.${F}`,
          V = D(l, Z);
        (a.array.has(g) || !I4(O) || (V && !V._f)) && !l3(O)
          ? Z1(Z, O, L)
          : x1(Z, O, L);
      }
    },
    ...
    I = async (g) => {
      ...
      let L = k.name,
        F = !0;
      const O = D(l, L),
        Z = () => (k.type ? a5(O._f) : Xu(g));
      if (O) {
        let V, u1;
        const f1 = Z(),
          $2 = g.type === t8.BLUR || g.type === t8.FOCUS_OUT,
          fl =
            (!ua(O._f) && !n.resolver && !D(r.errors, L) && !O._f.deps) ||
            aa($2, D(r.touchedFields, L), r.isSubmitted, x, y),
          jn = r8(L, a, $2);
        n1(o, L, f1),
          $2
            ? (O._f.onBlur && O._f.onBlur(g), c && c(0))
            : O._f.onChange && O._f.onChange(g);
        const Mn = M(L, f1, $2, !1),
          dl = !le(Mn) || jn;
        if (
          (!$2 && p.values.next({ name: L, type: g.type, values: { ...o } }),
          fl)
        )
          return (
            d.isValid && f(), dl && p.state.next({ name: L, ...(jn ? {} : Mn) })
          );
        if ((!$2 && jn && p.state.next({ ...r }), h(!0), n.resolver)) {
          const { errors: S6 } = await z([L]),
            Cl = a8(r.errors, l, L),
            A6 = a8(S6, l, Cl.name || L);
          (V = A6.error), (L = A6.name), (u1 = le(S6));
        } else
          (V = (await u8(O, o, A, n.shouldUseNativeValidation))[L]),
            (F = isNaN(f1) || f1 === D(o, L, f1)),
            F && (V ? (u1 = !1) : d.isValid && (u1 = await W(l, !0)));
        F && (O._f.deps && B(O._f.deps), E(L, u1, V, Mn));
      }
    },
    B = async (g, k = {}) => {
      let L, F;
      const O = s5(g);
      if ((h(!0), n.resolver)) {
        const Z = await P(p1(g) ? g : O);
        (L = le(Z)), (F = g ? !O.some((V) => D(Z, V)) : L);
      } else
        g
          ? ((F = (
              await Promise.all(
      ...
      return (
        p.state.next({
          ...(!_e(g) || (d.isValid && L !== r.isValid) ? {} : { name: g }),
          ...(n.resolver || !g ? { isValid: L } : {}),
          errors: r.errors,
          isValidating: !1,
        }),
        k.shouldFocus &&
          !F &&
          cr(l, (Z) => Z && D(r.errors, Z), g ? O : a.mount),
        F
      );
    },
    t1 = (g) => {
      const k = { ...s, ...(u.mount ? o : {}) };
      return p1(g) ? k : _e(g) ? D(k, g) : g.map((L) => D(k, L));
    },
    c1 = (g, k) => ({
      invalid: !!D((k || r).errors, g),
      isDirty: !!D((k || r).dirtyFields, g),
      isTouched: !!D((k || r).touchedFields, g),
      error: D((k || r).errors, g),
    }),
    B2 = (g) => {
      g && s5(g).forEach((k) => L1(r.errors, k)),
        p.state.next({ errors: g ? r.errors : {} });
    },
    ke = (g, k, L) => {
      const F = (D(l, g, { _f: {} })._f || {}).ref;
      n1(r.errors, g, { ...k, ref: F }),
        p.state.next({ name: g, errors: r.errors, isValid: !1 }),
        L && L.shouldFocus && F && F.focus && F.focus();
    },
    _3 = (g, k) =>
      n2(g)
        ? p.values.subscribe({ next: (L) => g(q(void 0, k), L) })
        : q(g, k, !0),
    de = (g, k = {}) => {
      for (const L of g ? s5(g) : a.mount)
        a.mount.delete(L),
          a.array.delete(L),
          k.keepValue || (L1(l, L), L1(o, L)),
          !k.keepError && L1(r.errors, L),
          !k.keepDirty && L1(r.dirtyFields, L),
          !k.keepTouched && L1(r.touchedFields, L),
          !n.shouldUnregister && !k.keepDefaultValue && L1(s, L);
      p.values.next({ values: { ...o } }),
        p.state.next({ ...r, ...(k.keepDirty ? { isDirty: $() } : {}) }),
        !k.keepIsValid && f();
    },
    He = (g, k = {}) => {
      let L = D(l, g);
      const F = C3(k.disabled);
      return (
        n1(l, g, {
          ...(L || {}),
          _f: {
            ...(L && L._f ? L._f : { ref: { name: g } }),
            name: g,
            mount: !0,
            ...k,
          },
        ...
        a.mount.add(g),
        L
          ? F && n1(o, g, k.disabled ? void 0 : D(o, g, a5(L._f)))
          : S(g, !0, k.value),
        {
          ...
          ...(n.progressive
            ? {
                ...
                min: z3(k.min),
                max: z3(k.max),
                minLength: z3(k.minLength),
                maxLength: z3(k.maxLength),
                pattern: z3(k.pattern),
              }
            : {}),
          name: g,
          onChange: I,
          ...
          ref: (O) => {
            if (O) {
              ...
              const Z =
                ...
                V = ia(Z),
                u1 = L._f.refs || [];
              if (V ? u1.find((f1) => f1 === Z) : Z === L._f.ref) return;
              n1(l, g, {
                _f: {
                  ...L._f,
                  ...(V
              ...
              (L = D(l, g, {})),
                ...
                (n.shouldUnregister || k.shouldUnregister) &&
                  !(Ku(a.array, g) && u.action) &&
                  a.unMount.add(g);
          },
        }
      );
    },
    k6 = () => n.shouldFocusError && cr(l, (g) => g && D(r.errors, g), a.mount),
    j6 = (g, k) => async (L) => {
      L && (L.preventDefault && L.preventDefault(), L.persist && L.persist());
      let F = Xe(o);
      if ((p.state.next({ isSubmitting: !0 }), n.resolver)) {
        const { errors: O, values: Z } = await z();
        (r.errors = O), (F = Z);
      } else await W(l);
      L1(r.errors, "root"),
        le(r.errors)
          ? (p.state.next({ errors: {} }), await g(F, L))
          : (k && (await k({ ...r.errors }, L)), k6(), setTimeout(k6)),
        p.state.next({
          isSubmitted: !0,
          isSubmitting: !1,
    ...
    cl = (g, k = {}) => {
      D(l, g) &&
        (p1(k.defaultValue)
          ? T(g, D(s, g))
          : (T(g, k.defaultValue), n1(s, g, k.defaultValue)),
        k.keepTouched || L1(r.touchedFields, g),
        k.keepDirty ||
          (L1(r.dirtyFields, g),
          (r.isDirty = k.defaultValue ? $(g, D(s, g)) : $())),
        k.keepError || (L1(r.errors, g), d.isValid && f()),
        p.state.next({ ...r }));
    },
    M6 = (g, k = {}) => {
      const L = g || s,
        F = Xe(L),
        O = g && !le(g) ? F : s;
      if ((k.keepDefaultValues || (s = L), !k.keepValues)) {
        if (k.keepDirtyValues || v)
          for (const Z of a.mount)
            D(r.dirtyFields, Z) ? n1(O, Z, D(o, Z)) : T(Z, D(O, Z));
        else {
          if (y6 && p1(g))
            for (const Z of a.mount) {
              const V = D(l, Z);
              if (V && V._f) {
                const u1 = Array.isArray(V._f.refs) ? V._f.refs[0] : V._f.ref;
                if (O4(u1)) {
                  const f1 = u1.closest("form");
                  if (f1) {
                    f1.reset();
                    break;
                  }
        ...
        (o = e.shouldUnregister ? (k.keepDefaultValues ? Xe(s) : {}) : Xe(O)),
    ...
    control: {
      ...
      _resetDefaultValues: () =>
        ...
        n.defaultValues().then((g) => {
          L6(g, n.resetOptions), p.state.next({ isLoading: !1 });
        }),
      _updateFormState: (g) => {
        r = { ...r, ...g };
      },
...
const Ca = "_taskInfo_1cod8_1",
  pa = "_form_1cod8_9",
  ha = "_label_1cod8_21",
  ma = "_input_1cod8_41",
  C1 = { taskInfo: Ca, form: pa, label: ha, input: ma };
function va(e) {
  const t = M1(),
    { selectAnswer: n, checkClick: r } = e,
    { register: l, getValues: s } = A3(),
    o = () => {
      const { name1: u, name2: a, name3: c, name4: m } = s();
      if (!u && !a && !c && !m) {
        n(!1);
        return;
      }
      n(!0), t(Y(u && a && c && !m ? "true" : "false"));
    };
  return i.jsx(i.Fragment, {
    children: i.jsxs("div", {
...
const ya = "_taskInfo_1l7ed_1",
  ga = "_form_1l7ed_9",
  xa = "_label_1l7ed_21",
  wa = "_input_1l7ed_37",
  Me = { taskInfo: ya, form: ga, label: xa, input: wa };
function ka(e) {
  const t = M1(),
    { selectAnswer: n, checkClick: r } = e,
    ...
    p = (y) => {
      !c ||
        ...
        (a &&
          ...
          (m += 3),
          m > 100 && (m = 100),
          a.style.setProperty("--var-width", `${m}%`)));
    },
    v = (y) => {
...
const ja = "_taskInfo_yd3h5_1",
  Ma = "_task_yd3h5_1",
  La = "_taskAnswer_yd3h5_23",
  Sa = "_answer_yd3h5_43",
  Aa = "_zero_yd3h5_63",
  _a = "_taskZeros_yd3h5_75",
  Za = "_none_yd3h5_113",
  Ea = "_success_yd3h5_119",
  Na = "_danger_yd3h5_125",
  Y1 = {
    taskInfo: ja,
    task: Ma,
    taskAnswer: La,
...
function Ta(e) {
  ...
  const y = (C) => {
      (document.body.style.overflow = "hidden"),
        (v = C.changedTouches[0].target),
        (v.style.left = "auto"),
        (v.style.top = "auto"),
        (v.style.position = "absolute");
      const f = v.offsetLeft,
        h = v.offsetTop;
    ...
    A = (C) => {
      (document.body.style.overflow = "auto"),
        !(v && ((v.style.position = "static"), v.style.top !== "59.5px")) &&
          (n(!0),
          s(l.map((f, h) => (h === C ? (f.answer = !0) : (f.answer = !1), f))),
          u(l[C]),
          C === 1 ? (t(Y("true")), c(!0)) : (t(Y("false")), c(!1)));
    };
  return i.jsx(i.Fragment, {
    children: i.jsxs("div", {
...
function Va(e) {
  ...
  N.useEffect(() => {
    if (s.current) {
      ...
      if (((x = S.left), (A = S.top), o.current)) {
        const M = o.current.getBoundingClientRect();
        (l[0].top = M.top + M.height / 2 - S.top - 21.5),
          (l[0].left = Math.ceil(M.left + M.width / 2 - S.left - 10));
      }
      if (u.current) {
        const M = u.current.getBoundingClientRect();
        (l[1].top = M.top + M.height / 2 - S.top - 21.5),
          (l[1].left = Math.ceil(M.left + M.width / 2 - S.left - 10));
      }
      if (a.current) {
        const M = a.current.getBoundingClientRect();
        (l[2].top = M.top + M.height / 2 - S.top - 21.5),
          (l[2].left = Math.ceil(M.left + M.width / 2 - S.left - 10));
      }
      if (c.current) {
        const M = c.current.getBoundingClientRect();
        (l[3].top = M.top + M.height / 2 - S.top - 21.5),
          (l[3].left = Math.ceil(M.left + M.width / 2 - S.left - 10));
      }
    }
  });
  ...
  let x = 0,
    ...
    f;
  const h = (S) => {
      S.preventDefault(), (document.body.style.overflow = "hidden");
      const M = S.changedTouches[0];
      if (
        ((f = S.changedTouches[0].target.closest("svg")),
        (p.current = "transparent"),
        f)
      ) {
        (f.style.position = "absolute"), (C = f.width.animVal.value);
        const z = M.clientY - A,
          P = M.clientX - x - C / 2;
        (f.style.left = P + "px"), (f.style.top = z + "px");
      }
    },
    w = (S) => {
      S.preventDefault();
      ...
      (p.current = "transparent"),
        f &&
          (z > 52 && z < 223 && (f.style.left = z + "px"),
          E > -15 && E < 112 && (f.style.top = E + "px"));
    },
    j = () => {
      if (((document.body.style.overflow = "auto"), f)) {
        const S = parseInt(f.style.left),
        ...
        l.forEach((z, P) => {
          z.left + 4 >= S &&
            ...
            (p.current = "#fff"),
            (E = P),
            E === 3 ? (t(Y("true")), y(!0)) : (t(Y("false")), y(!1)),
            f &&
              ((f.style.left = z.left + "px"), (f.style.top = z.top + "px")));
        }),
          E === -3 && n(!1),
          d(m.map((z, P) => (E === P ? (z.check = !0) : (z.check = !1), z)));
      }
    };
  return i.jsx(i.Fragment, {
    children: i.jsxs("div", {
                ...
                i.jsxs(
                  "div",
                  {
                    ...
                    children: [
                      i.jsx("span", {
                        style: {
                          background: S.check ? p.current : "transparent",
                        },
                        className: w2.answer,
                        ref: M === 0 ? o : M === 1 ? u : M === 2 ? a : c,
                      }),
                      i.jsx("span", { className: w2.name, children: S.name }),
                    ],
                  },
                  M
                )
...
function Ga(e) {
  ...
  const x = (f) => {
    ...
    A = (f) => {
      ...
      let M, E;
      l.current >= 0 ? (E = l.current % 360) : (E = 360 + (l.current % 360));
      const z = Math.floor(E / 30);
      E % 30 > 15 ? (M = z * 30 + 30) : (M = z * 30),
        M === 360 && (M = 0),
        M !== p &&
          ((u.current = u.current.map(
            (U) => (U.deg === M ? (U.check = !0) : (U.check = !1), U)
          )),
          v(M));
      const P = E % 360,
        W = P >= 0 && P < 90 ? 1 : P >= 90 && P < 180 ? 2 : P >= 270 ? 4 : 3;
      (W === 1 && a <= j && m >= S) ||
      (W === 2 && a <= j && m <= S) ||
      (W === 3 && a >= j && m <= S) ||
      (W === 4 && a >= j && m >= S)
        ...
        : (l.current = l.current - 2),
        y && y.style.setProperty("--rotate", `${l.current}deg`),
        c(j),
        d(S);
    },
    C = () => {
      (document.body.style.overflow = "auto"),
        t(Y(p === 180 ? "true" : "false")),
        n(!0);
    };
  return i.jsx(i.Fragment, {
    children: i.jsxs("div", {
      ...
      children: [
        ...
        i.jsxs("div", {
          ...
          children: [
            i.jsx("div", {
              className: Pe.numbers,
              children: u.current.map((f, h) =>
                i.jsx(
                  "span",
                  {
                    "data-value": f.value,
                    className: f.check ? Pe.check : "",
                    children: f.value,
                  },
                  h
                )
              ...
              "label",
              {
                ...
                children: [
                  ...
                  i.jsxs("div", {
                    className: D3.answer,
                    children: [
                      i.jsx("img", { src: u[m], alt: c.nameEN }),
...
const hc = "_taskInfo_iy5nf_1",
  mc = "_task_iy5nf_1",
  vc = "_taskAnswer_iy5nf_23",
  yc = "_answer_iy5nf_45",
  gc = "_zero_iy5nf_63",
  xc = "_taskZeros_iy5nf_75",
  wc = "_none_iy5nf_111",
  kc = "_success_iy5nf_117",
  jc = "_danger_iy5nf_123",
  X1 = {
    taskInfo: hc,
    task: mc,
    taskAnswer: vc,
...
const Oc = "_taskInfo_wtwrs_1",
  Rc = "_task_wtwrs_1",
  Ic = "_text_wtwrs_21",
  zc = "_number_wtwrs_43",
  j2 = { taskInfo: Oc, task: Rc, text: Ic, number: zc },
  c8 =
      ...
      children: [
        ...
        i.jsxs("div", {
          ...
          children: [
            ...
            i.jsx(f8, { click: d, value: l, className: j2.number }),
            i.jsx(f8, { click: y, value: p, className: j2.number }),
...
function Xc(e) {
  ...
  const [u, a] = N.useState([!1, !1, !1, !1]),
    [c, m] = N.useState("-1");
  let d;
  const p = (x) => {
      if (
        ((document.body.style.overflow = "hidden"),
        (d = x.changedTouches[0].target.closest("div")),
        d)
      ) {
        if (d.style.position === "absolute") return;
        (d.style.left = "auto"),
          (d.style.top = "auto"),
          (d.style.transform = "none"),
          (d.style.position = "absolute");
        let C = d.offsetLeft - d.offsetWidth;
        C < 0 && (C = d.offsetLeft);
        let f = d.offsetTop - d.offsetHeight / 2;
        (f < 0 || f === 56) && (f = d.offsetTop),
          (d.style.zIndex = "1"),
          (d.style.left = C + "px"),
          (d.style.top = f + "px");
      }
      ...
      if (d) {
        ...
        if (
          ...
          if (
            ...
            if (u[+h]) return;
            a(u.map((w, j) => (j + "" === h ? (w = !0) : (w = !1), w))), m(h);
          }
        }
      }
    },
    y = () => {
      if (((document.body.style.overflow = "auto"), d)) {
        if (d.style.top !== "30%" && d.style.left !== "50%") {
          d.style.position = "static";
          return;
        }
        return;
...
const Gc = "_taskInfo_sk5qx_1",
  ...
  qc = "_label_sk5qx_23",
  bc = "_input_sk5qx_39",
  Le = { taskInfo: Gc, form: Kc, label: qc, input: bc };
function Jc(e) {
  const t = M1(),
    { selectAnswer: n, checkClick: r } = e,
...
const ef = "_taskInfo_1r0oy_1",
  tf = "_task_1r0oy_1",
  nf = "_taskAnswer_1r0oy_27",
  rf = "_taskText_1r0oy_41",
  lf = "_taskCheck_1r0oy_59",
  sf = "_taskCups_1r0oy_73",
  re = {
    taskInfo: ef,
    task: tf,
    taskAnswer: nf,
...
function of(e) {
  ...
  N.useEffect(() => {
    ...
    s.current &&
      ((p[0].top = s.current.offsetTop), (p[0].left = s.current.offsetLeft)),
      o.current &&
        ((p[1].top = o.current.offsetTop), (p[1].left = o.current.offsetLeft)),
      u.current &&
        ((p[2].top = u.current.offsetTop), (p[2].left = u.current.offsetLeft)),
      a.current &&
        ((p[3].top = a.current.offsetTop), (p[3].left = a.current.offsetLeft));
  });
  const v = N.useRef([!1, !1, !1, !1]),
    y = (C) => {
      (document.body.style.overflow = "hidden"),
        (d = C.changedTouches[0].target);
      const f = d.getAttribute("data-index");
      f && (v.current = v.current.map((j, S) => (S === +f ? !1 : j)));
      let h, w;
      d.style.position === "static"
        ? ((w = d.offsetTop),
          (h = d.offsetLeft),
    ...
    x = (C) => {
      ...
      const h = f.clientY - m - d.offsetHeight / 2,
        w = f.clientX - c - d.offsetWidth / 2;
      (d.style.position = "absolute"),
        (d.style.zIndex = "1"),
        w > 169 && w < 254 && (d.style.left = w + "px"),
        h > 0 && h < 112 && (d.style.top = h + "px");
    },
    A = () => {
      if (((document.body.style.overflow = "auto"), !d)) return;
      const C = {
        ...
        f = p.findIndex(
          (w) =>
            w.top - 5 <= C.top && w.top + 5 >= C.top && w.left + 5 >= C.left
        );
      if (f === -1) {
        (d.style.position = "static"),
          (d.style.left = "auto"),
      ...
      d.setAttribute("data-index", f + ""),
        (v.current = v.current.map((w, j) => (j === f ? !0 : w)));
      let h = 0;
      for (let w = 0; w < v.current.length; w++) {
        const j = v.current[w];
        j && h++, h === 3 && (n(!0), t(Y(w === 3 && j ? "false" : "true")));
      }
    };
  return i.jsx(i.Fragment, {
    children: i.jsxs("div", {
          ...
          children: [
            i.jsxs("div", {
              ...
              children: [
                ...
                i.jsx("div", { className: re.taskCheck, ref: s }),
                i.jsxs("div", {
                  className: re.taskText,
                  children: [
                    "Лучший работодатель ",
                ...
                i.jsx("div", { className: re.taskCheck, ref: o }),
                i.jsxs("div", {
                  className: re.taskText,
                  children: [
                    "Лучший работодатель ",
                ...
                i.jsx("div", { className: re.taskCheck, ref: u }),
                i.jsxs("div", {
                  className: re.taskText,
                  children: [
                    "Лучший работодатель ",
                ...
                i.jsx("div", { className: re.taskCheck, ref: a }),
              ],
            }),
            i.jsxs("div", {
  ...
  Cf = [
    [
      ...
      },
      {
        ...
        answer:
          "Хотелось бы получить премию UGC, но пока что такой не существует, а аббревиатура расшифровывается как User Genereted Content :)",
        sizeAnswer: "15px",
      ...
      },
      {
        ...
        answer:
          "Engineering, procurement, and construction (EPC), Система автоматизированного проектирования (САПР) и Building Information Model (BIM) – это про нас, а вот User Genereted Content (UGC) – это что-то<br>из области маркетинга :)",
        sizeAnswer: "12px",
      ...
      },
      {
        ...
        answer:
          "НИПИГАЗ проектирует масштабные объекты в области нефтегазопереработки<br>и нефтегазохимии, а авто и роботы – не наш профиль",
        sizeAnswer: "14px",
        paddingQuestion: "0px",
        paddingAnswer: "20px",
      },
    ...
    [
      ...
      },
      {
        ...
        answer:
          "Программа “Молодой специалист” — это возможность начать карьеру в одной из ведущих инжиниринговых компаний мира, включиться в крупные проекты<br>и обменяться опытом в компании, которая заботится<br>о своих сотрудниках",
        sizeAnswer: "12px",
        paddingQuestion: "0px",
        paddingAnswer: "0px",
        paddingAnswerBtm: "20px",
...
function hf(e) {
  const { openFirework: t, openTask: n, closePoints: r } = e,
    ...
    [o, u] = N.useState(!1),
    a = M1(),
    c = P2((I) => I.activeQuestion).activeQuestion,
    m = P2((I) => I.arrQuestionsReducer).arrQuestions;
  let d = 0,
  ...
  if (c[0] !== 4) {
    ...
    (v = I.question),
      ...
      (x = I.paddingAnswer),
      (A = I.paddingQuestion),
      (C = I.paddingAnswerBtm ? I.paddingAnswerBtm : "29px");
  }
  const [f, h] = N.useState("15px"),
    w = { fontSize: f },
    [j, S] = N.useState(A),
    [M, E] = N.useState("29px"),
    z = { paddingRight: j, paddingBottom: M },
    P = P2((I) => I.checkAnswerReducer).checkAnswer,
    [W, U] = N.useState("wait"),
    [$, q] = N.useState(!1),
    g1 = (I) => {
      q(I);
              ...
              children: [
                i.jsx("div", {
                  ...
                  children:
                    W === "wait"
                      ? (c[1] + 1) * 100
                      : i.jsx(pf, { check: W === "true" }),
                }),
                i.jsx("h3", {
                  className: "task__title " + (l ? "answer" : ""),
                  style: w,
                  dangerouslySetInnerHTML: l ? { __html: p } : { __html: v },
                }),
              ],
            }),
          }),
          i.jsx(df, { selectAnswer: g1, checkClick: l }),
          i.jsx("button", {
            className: "btn task__btn",
            onClick: T,
            children: W === "wait" ? "ГОТОВО" : "ОГО",
          }),
        ],
      }),
    }),
