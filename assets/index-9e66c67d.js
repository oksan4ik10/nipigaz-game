...
function Ht(e, t, n, r, l) {
  ...
  if (((o = 0), (r = r === "" ? "." : r + ":"), Z6(e)))
    ...
    for (e = u.call(e), a = 0; !(s = e.next()).done; )
      (s = s.value), (u = r + Ln(s, a++)), (o += Ht(s, t, n, u, l));
  else if (s === "object")
    throw (
      ((t = String(e)),
      Error(
      ...
      return (
        ...
        V > t1
          ? ((T.sortIndex = V),
            ...
            n(u) === null &&
              T === n(c) &&
              (g ? (d(E), (E = -1)) : (g = !0), Z1(w, V - t1)))
          : ((T.sortIndex = c1), t(u, T), x || v || ((x = !0), x1(j))),
        T
      );
    }),
...
function Xl(e, t, n, r, l, s, o, a, u) {
  (Q3 = !1), (i4 = null), Hl.apply(Yl, arguments);
}
function Gl(e, t, n, r, l, s, o, a, u) {
...
function T3(e, t) {
  e.blockedOn === t &&
    ...
    E5 ||
      ((E5 = !0),
      J1.unstable_scheduleCallback(J1.unstable_NormalPriority, cs)));
}
function lt(e) {
  function t(l) {
    return T3(l, e);
...
function Lr(e, t, n, r) {
  if (c4) {
    ...
    else if (us(l, e, t, n, r)) r.stopPropagation();
    else if ((V6(e, r), t & 4 && -1 < as.indexOf(e))) {
      for (; l !== null; ) {
        var s = jt(l);
        if (
          (s !== null && q8(s),
...
function q6() {
  Y3 && (Y3.detachEvent("onpropertychange", u0), (st = Y3 = null));
}
function u0(e) {
...
function Bs(e, t, n) {
  e === "focusin"
    ? (q6(), (Y3 = t), (st = n), Y3.attachEvent("onpropertychange", u0))
    : e === "focusout" && q6();
}
function $s(e) {
...
function Un(e, t, n, r, l) {
  ...
  B8(function () {
    ...
    if (!(t & 7)) {
      ...
      switch (((M = c ? q2(c) : window), e)) {
        case "focusin":
          (G6(M) || M.contentEditable === "true") &&
            ((G2 = M), (T5 = c), (X3 = null));
          break;
        case "focusout":
          X3 = T5 = G2 = null;
      ...
      E &&
        ...
        0 < M.length &&
          ...
          L ? (E.data = L) : ((L = i0(n)), L !== null && (E.data = L)))),
        (L = zs ? Is(e, n) : Ds(e, n)) &&
...
function d4(e, t) {
  for (var n = t + "Capture", r = []; e !== null; ) {
    ...
    l.tag === 5 &&
      ...
      ((l = s),
      (s = tt(e, n)),
      s != null && r.unshift(at(e, s, l)),
      (s = tt(e, t)),
      s != null && r.push(at(e, s, l))),
      (e = e.return);
  }
  return r;
}
...
function r9(e, t, n, r, l) {
  for (var s = t._reactName, o = []; n !== null && n !== r; ) {
    ...
    a.tag === 5 &&
      ...
      ((a = c),
      l
        ? ((u = tt(n, s)), u != null && o.unshift(at(n, u, a)))
        : l || ((u = tt(n, s)), u != null && o.push(at(n, u, a)))),
      (n = n.return);
  }
...
function j0(e, t, n) {
  (se[ie++] = ze), (se[ie++] = Ie), (se[ie++] = O2), (O2 = e);
  var r = ze;
  e = Ie;
  var l = 32 - ge(r) - 1;
  (r &= ~(1 << l)), (n += 1);
...
function W5(e, t, n, r) {
  ...
  typeof s == "object" && s !== null
    ? (l.context = ue(s))
    : ((s = Q1(t) ? R2 : R1.current), (l.context = h3(e, s))),
...
function Z0(e) {
  ...
  function m(d, f, h, w, j) {
    return f === null || f.tag !== 7
      ? ((f = T2(h, d.mode, w, j)), (f.return = d), f)
      : ((f = l(f, h)), (f.return = d), f);
  }
  function C(d, f, h) {
  ...
  function p(d, f, h, w) {
    ...
    if ((typeof h == "string" && h !== "") || typeof h == "number")
      return j !== null ? null : a(d, f, "" + h, w);
    if (typeof h == "object" && h !== null) {
      switch (h.$$typeof) {
        case At:
          return h.key === j ? u(d, f, h, w) : null;
        case H2:
          return h.key === j ? c(d, f, h, w) : null;
        case Xe:
          return (j = h._init), p(d, f, j(h._payload), w);
      }
      if (U3(h) || Z3(h)) return j !== null ? null : m(d, f, h, w, null);
      Dt(d, h);
    }
    return null;
  }
  function v(d, f, h, w, j) {
    if ((typeof w == "string" && w !== "") || typeof w == "number")
      return (d = d.get(h) || null), a(f, d, "" + w, j);
    if (typeof w == "object" && w !== null) {
      switch (w.$$typeof) {
        case At:
          return (d = d.get(w.key === null ? h : w.key) || null), u(f, d, w, j);
        case H2:
          return (d = d.get(w.key === null ? h : w.key) || null), c(f, d, w, j);
        case Xe:
          var M = w._init;
          return v(d, f, h, M(w._payload), j);
      }
      if (U3(w) || Z3(w)) return (d = d.get(h) || null), m(f, d, w, j, null);
      Dt(f, w);
    }
    return null;
  }
  function x(d, f, h, w) {
    for (
      var j = null, M = null, L = f, E = (f = 0), D = null;
      L !== null && E < h.length;
      E++
    ) {
      L.index > E ? ((D = L), (L = null)) : (D = L.sibling);
      var z = p(d, L, h[E], w);
      if (z === null) {
        L === null && (L = D);
        break;
      }
      e && L && z.alternate === null && t(d, L),
        (f = s(z, f, E)),
        M === null ? (j = z) : (M.sibling = z),
        (M = z),
        (L = D);
    }
    if (E === h.length) return n(d, L), l1 && M2(d, E), j;
    if (L === null) {
      for (; E < h.length; E++)
        (L = C(d, h[E], w)),
          L !== null &&
            ((f = s(L, f, E)), M === null ? (j = L) : (M.sibling = L), (M = L));
      return l1 && M2(d, E), j;
    }
    for (L = r(d, L); E < h.length; E++)
      (D = v(L, d, E, h[E], w)),
        D !== null &&
          (e && D.alternate !== null && L.delete(D.key === null ? E : D.key),
          (f = s(D, f, E)),
          M === null ? (j = D) : (M.sibling = D),
          (M = D));
    return (
      e &&
  ...
  function g(d, f, h, w) {
    ...
    for (
      var M = (j = null), L = f, E = (f = 0), D = null, z = h.next();
      L !== null && !z.done;
      E++, z = h.next()
    ) {
      L.index > E ? ((D = L), (L = null)) : (D = L.sibling);
      var Q = p(d, L, z.value, w);
      if (Q === null) {
        L === null && (L = D);
        break;
      }
      e && L && Q.alternate === null && t(d, L),
        (f = s(Q, f, E)),
        M === null ? (j = Q) : (M.sibling = Q),
        (M = Q),
        (L = D);
    }
    if (z.done) return n(d, L), l1 && M2(d, E), j;
    if (L === null) {
      for (; !z.done; E++, z = h.next())
        (z = C(d, z.value, w)),
          z !== null &&
            ((f = s(z, f, E)), M === null ? (j = z) : (M.sibling = z), (M = z));
      return l1 && M2(d, E), j;
    }
    for (L = r(d, L); !z.done; E++, z = h.next())
      (z = v(L, d, E, z.value, w)),
        z !== null &&
          (e && z.alternate !== null && L.delete(z.key === null ? E : z.key),
          (f = s(z, f, E)),
          M === null ? (j = z) : (M.sibling = z),
          (M = z));
    return (
  ...
  function A(d, f, h, w) {
    if (
      ...
      switch (h.$$typeof) {
        case At:
          e: {
            for (var j = h.key, M = f; M !== null; ) {
              if (M.key === j) {
                if (((j = h.type), j === Y2)) {
                  if (M.tag === 7) {
                    n(d, M.sibling),
                      (f = l(M, h.props.children)),
                      (f.return = d),
                      (d = f);
                    break e;
                  }
        ...
        case H2:
          ...
          return o(d);
        case Xe:
          return (M = h._init), A(d, f, M(h._payload), w);
      }
...
function $r(e, t, n, r, l, s) {
  if (
    ...
    (t.updateQueue = null),
    (t.lanes = 0),
    (Jt.current = e === null || e.memoizedState === null ? fi : di),
    (e = n(r, l)),
    G3)
  ) {
    s = 0;
...
var k4 = {
    ...
    useReducer: function (e, t, n) {
      ...
      return (
        ...
        (r.queue = e),
        (e = e.dispatch = ui.bind(null, i1, e)),
        [r.memoizedState, e]
      );
    },
    useRef: function (e) {
    ...
    useTransition: function () {
      var e = m9(!1),
        t = e[0];
      return (e = ai.bind(null, e[1])), (Se().memoizedState = e), [t, e];
    },
    ...
    useSyncExternalStore: function (e, t, n) {
      ...
      return (
        ...
        (r.flags |= 2048),
        pt(9, O0.bind(null, r, s, n, t), void 0, null),
        n
      );
    },
    useId: function () {
...
function j9(e, t, n, r, l) {
  if (e === null) {
    ...
    return typeof s == "function" &&
      ...
      ? ((t.tag = 15), (t.type = s), b0(e, t, s, r, l))
...
function Y5(e, t, n, r, l, s) {
  t7(e, t);
  var o = (t.flags & 128) !== 0;
  if (!r && !o) return l && a9(t, n, !1), Be(e, t, s);
  ...
  return (
    (t.flags |= 1),
    e !== null && o
      ? ((t.child = v3(t, e.child, null, s)), (t.child = v3(t, null, a, s)))
      : O1(e, t, a, s),
...
function r7(e, t, n) {
  ...
  if (s) {
    ...
    return (
      ...
      a !== null ? (s = u2(a, s)) : ((s = T2(s, o, n, null)), (s.flags |= 2)),
      (s.return = t),
      (r.return = t),
      (r.sibling = s),
      (t.child = r),
  ...
  return (
    (s = e.child),
    (e = s.sibling),
    (r = u2(s, { mode: "visible", children: r.children })),
    !(t.mode & 1) && (r.lanes = n),
    (r.return = t),
    (r.sibling = null),
    e !== null &&
...
function mi(e, t, n, r, l, s, o) {
  ...
  if (l.data === "$!") {
    ...
    return (r = a), (s = Error(_(419))), (r = Yn(s, r, void 0)), Ft(e, t, o, r);
  }
  if (((a = (o & e.childLanes) !== 0), $1 || a)) {
    if (((r = j1), r !== null)) {
      ...
      (l = l & (r.suspendedLanes | o) ? 0 : l),
        l !== 0 &&
          l !== s.retryLane &&
          ((s.retryLane = l), Ve(e, l), xe(r, e, l, -1));
    }
...
function l7(e, t, n) {
  var r = t.pendingProps,
    l = r.revealOrder,
    s = r.tail;
  if ((O1(e, t, r.children, n), (r = s1.current), r & 2))
    (r = (r & 1) | 2), (t.flags |= 128);
  else {
  ...
  if ((J(s1, r), !(t.mode & 1))) t.memoizedState = null;
  else
    switch (l) {
      case "forwards":
    ...
    case 13:
      if (((r = t.memoizedState), r !== null))
        return r.dehydrated !== null
          ? (J(s1, s1.current & 1), (t.flags |= 128), null)
    ...
    case 5:
      ...
      if (((n = t.type), e !== null && t.stateNode != null))
        ...
        if (((e = Z2(Ee.current)), It(t))) {
          ...
          switch (((r[Ae] = t), (r[ut] = s), (e = (t.mode & 1) !== 0), n)) {
            case "dialog":
      ...
      return t.flags & 128
        ...
        : ((r = r !== null),
          r !== (e !== null && e.memoizedState !== null) &&
            ...
            ((t.child.flags |= 8192),
            t.mode & 1 &&
              (e === null || s1.current & 1 ? v1 === 0 && (v1 = 3) : br())),
              ...
              if (((o = w4(e)), o !== null)) {
                for (
                  ...
                  (s = n),
                    ...
                    (n = n.sibling);
                return J(s1, (s1.current & 1) | 2), t.child;
              }
              e = e.sibling;
            }
          s.tail !== null &&
            d1() > x3 &&
            ((t.flags |= 128), (r = !0), O3(s, !1), (t.lanes = 4194304));
        }
      else {
        if (!r)
          if (((e = w4(o)), e !== null)) {
...
function a7(e) {
  ...
  t !== null && ((e.alternate = null), a7(t)),
    ...
    e.tag === 5 &&
      ((t = e.stateNode),
      t !== null &&
        (delete t[Ae], delete t[ut], delete t[D5], delete t[ri], delete t[li])),
    (e.stateNode = null),
    (e.return = null),
    (e.dependencies = null),
    ...
    case 5:
      ...
      if (r & 4 && ((l = e.stateNode), l != null)) {
        ...
        if (((e.updateQueue = null), u !== null))
          try {
            a === "input" && s.type === "radio" && s.name != null && T8(l, s),
              M5(a, o);
            var c = M5(a, s);
...
function L2(e, t, n) {
  var r = X,
    l = ae.transition;
  try {
    (ae.transition = null), (X = 1), Ai(e, t, n, r);
  } finally {
    (ae.transition = l), (X = r);
  }
  return null;
...
function Ai(e, t, n, r) {
  ...
  if (
    ...
    (s = ae.transition), (ae.transition = null);
    var o = X;
    X = 1;
    var a = H;
    (H |= 4),
      ...
      return (
        ...
        l.$$typeof === void 0
          ? ((t.tag = 1),
            ...
            W5(t, r, e, n),
            (t = Y5(null, t, r, !0, s, n)))
          : ((t.tag = 0), l1 && s && Nr(t), O1(null, t, l, n), (t = t.child)),
        t
      );
    case 16:
      r = t.elementType;
...
function j7(e, t, n, r, l, s, o, a, u) {
  return (
    (e = t6(n, r, !0, e, l, s, o, a, u)),
    (e.context = w7(null)),
    (n = e.current),
    (r = I1()),
    (l = a2(n)),
...
var Ii = { usingClientEntryPoint: !1, Events: [jt, q2, $4, D8, F8, qr] },
  ...
  Di = {
    ...
    findFiberByHostInstance: z3.findFiberByHostInstance || Oi,
...
function fo(e = p2) {
  ...
  return function (r, l = {}) {
    ...
    const v = N.useCallback(
      ...
      x = T7(c.addNestedSub, u.getState, m || u.getState, v, s);
...
function _o({
  ...
  const u = t || p2;
  return N.createElement(u.Provider, { value: o }, n);
}
function D7(e = p2) {
  const t = e === p2 ? N7 : s6(e);
  return function () {
...
function V9(e, t, n, r, l, s, o) {
  if (h2(l)) {
    var a = E4(e, l, s && t && t.i !== 3 && !f3(t.R, r) ? s.concat(r) : void 0);
...
function Fo() {
  ...
  function n(s) {
    for (var o = s.t, a = s.k, u = d3(a), c = u.length - 1; c >= 0; c--) {
      var m = u[c];
      if (m !== r1) {
        var C = o[m];
...
function H7(e) {
  ...
  return function (u, c) {
    ...
    for (var m = !1, C = {}, p = 0; p < s.length; p++) {
      var v = s[p],
        x = n[v],
        g = u[v],
        A = x(g, c);
    ...
    return (m = m || s.length !== Object.keys(u).length), m ? C : u;
  };
}
function P4() {
...
function Go() {
  ...
  return function (r) {
    return function () {
      ...
      return (
        (s = P4.apply(void 0, a)(l.dispatch)),
        X9(X9({}, l), {}, { dispatch: s })
      );
    };
  };
...
function Y7(e) {
  var t = function (r) {
    ...
    return function (o) {
      return function (a) {
        return typeof a == "function" ? a(l, s, e) : o(a);
      };
    };
  };
  return t;
  ...
  na = function (e, t, n) {
    return new Promise(function (r, l) {
      var s = function (u) {
        ...
        a = function (u) {
          return u.done ? r(u.value) : Promise.resolve(u.value).then(s, o);
        };
  ...
  function u() {
    ...
    return Ca(n, function (f) {
      ...
      for (var w = 0, j = x; w < j.length; w++) {
        var M = j[w];
        f.addMatcher(M.matcher, M.reducer);
      }
...
function Pa(e) {
  const { arrQuestions: t } = P2((s) => s.arrQuestionsReducer),
    ...
    l = (s) => {
      t[s[0]][s[1]] !== 0 && (e.openTask(!0), n(b7(s)));
    };
  return i.jsx(i.Fragment, {
    children: i.jsx("div", {
...
const Oa = "_task__info_15avx_1",
  ...
  U1 = () =>
    i.jsx(i.Fragment, {
      children: i.jsx("div", { className: Fa.opacityTask }),
    });
function Ua(e) {
...
function Ya(e) {
  ...
  const p = (g) => {
      ...
      if (((C = g.changedTouches[0].target), C.style.position === "absolute"))
        return;
      (C.style.position = "absolute"), console.log(o, A.pageY, C.offsetHeight);
      const d = A.pageX - s - C.offsetWidth / 2,
        f = A.pageY - o - C.offsetHeight / 2;
      (C.style.zIndex = "1"),
        (C.style.left = d + "px"),
        (C.style.top = f + "px");
    },
      ...
      children: [
        ...
        i.jsxs("div", {
          ...
          children: [
            ...
            i.jsx("div", {
              className: $t.cart,
              children: i.jsx("img", { src: Ha, alt: "cart" }),
            }),
          ],
        }),
      ],
...
var _e = (e) => typeof e == "string",
  tu = (e, t, n, r, l) =>
    _e(e)
      ? (r && t.watch.add(e), I(n, e, l))
      : Array.isArray(e)
      ? e.map((s) => (r && t.watch.add(s), I(n, s)))
      : (r && (t.watchAll = !0), n),
  g6 = (e) => /^\w*$/.test(e),
...
var Q2 = (e) => (y1(e) && !O4(e) ? e : { value: e, message: "" }),
  a8 = async (e, t, n, r, l) => {
    ...
    const h = o ? o[0] : s,
      ...
      E = M || L,
      D =
        ((g || x6(s)) && p1(s.value) && p1(f)) ||
        (R4(s) && s.value === "") ||
        f === "" ||
        (Array.isArray(f) && !f.length),
      z = nu.bind(null, x, n, j),
    ...
    if (!D && (!z1(m) || !z1(C))) {
      ...
      if (($ || B) && (Q(!!$, q.message, g1.message, Te.max, Te.min), !n))
        return w(j[x].message), j;
    }
    if ((u || c) && !D && (_e(f) || (l && Array.isArray(f)))) {
      const $ = Q2(u),
        B = Q2(c),
    ...
    if (p && !D && _e(f)) {
      ...
      if (
        O4($) &&
        !f.match($) &&
        ((j[x] = { type: Te.pattern, message: B, ref: s, ...z(Te.pattern, B) }),
        !n)
      )
        return w(B), j;
    }
    if (v) {
      if (t2(v)) {
        const $ = await v(f, t),
          B = o8($, h);
        if (B && ((j[x] = { ...B, ...z(Te.validate, B.message) }), !n))
        ...
        for (const B in v) {
          ...
          q &&
            (($ = { ...q, ...z(B, q.message) }), w(q.message), n && (j[x] = $));
        }
        if (!le($) && ((j[x] = { ref: h, ...$ }), !n)) return j;
      }
    }
    return w(!0), j;
  };
...
function L1(e, t) {
  ...
  return (
    r && delete r[s],
    l !== 0 &&
      ((y1(r) && le(r)) || (Array.isArray(r) && su(r))) &&
      L1(e, n.slice(0, -1)),
    e
  );
}
...
function du(e = {}, t) {
  ...
  const C = {
    ...
    w = (y, k = [], S, F, P = !0, Z = !0) => {
      if (F && S) {
        if (((a.action = !0), Z && Array.isArray(I(l, y)))) {
          const U = S(I(l, y), F.argA, F.argB);
          P && n1(l, y, U);
        }
        if (Z && Array.isArray(I(r.errors, y))) {
          const U = S(I(r.errors, y), F.argA, F.argB);
          P && n1(r.errors, y, U), cu(r.errors, y);
        }
        if (C.touchedFields && Z && Array.isArray(I(r.touchedFields, y))) {
          const U = S(I(r.touchedFields, y), F.argA, F.argB);
          P && n1(r.touchedFields, y, U);
        }
        C.dirtyFields && (r.dirtyFields = a5(s, o)),
          p.state.next({
            name: y,
            isDirty: B(y, k),
    ...
    E = (y, k, S, F) => {
      const P = I(r.errors, y),
        Z = C.isValid && C3(k) && r.isValid !== k;
      if (
        (e.delayError && S
          ? ((c = d(() => j(y, S))), c(e.delayError))
          : (clearTimeout(m),
            (c = null),
        ...
        if (P) {
          ...
          if (Z) {
            const a1 = u.array.has(Z.name),
              f1 = await a8(P, o, A, n.shouldUseNativeValidation && !k, a1);
    ...
    q = (y, k, S) =>
      tu(y, u, { ...(a.mount ? o : p1(k) ? s : _e(y) ? { [y]: k } : k) }, S, k),
    g1 = (y) =>
      Lt(I(a.mount ? o : s, y, e.shouldUnregister ? I(s, y, []) : [])),
    x1 = (y, k, S = {}) => {
      const F = I(l, y);
      let P = k;
      if (F) {
      ...
      (S.shouldDirty || S.shouldTouch) &&
        L(y, P, S.shouldTouch, S.shouldDirty, !0),
    ...
    O = async (y) => {
      ...
      let S = k.name,
        F = !0;
      const P = I(l, S),
        Z = () => (k.type ? u5(P._f) : Xa(y));
      if (P) {
        let U, a1;
        const f1 = Z(),
          $2 = y.type === t8.BLUR || y.type === t8.FOCUS_OUT,
          fl =
            (!au(P._f) && !n.resolver && !I(r.errors, S) && !P._f.deps) ||
            uu($2, I(r.touchedFields, S), r.isSubmitted, g, x),
          kn = r8(S, u, $2);
        n1(o, S, f1),
          $2
        ...
        if ((!$2 && kn && p.state.next({ ...r }), h(!0), n.resolver)) {
          ...
          (U = (await a8(P, o, A, n.shouldUseNativeValidation))[S]),
            (F = isNaN(f1) || f1 === I(o, S, f1)),
            F && (U ? (a1 = !1) : C.isValid && (a1 = await Q(l, !0)));
        F && (P._f.deps && V(P._f.deps), E(S, a1, U, Mn));
      }
    },
    V = async (y, k = {}) => {
      let S, F;
      ...
      return (
        ...
        k.shouldFocus &&
          !F &&
          cr(l, (Z) => Z && I(r.errors, Z), y ? P : u.mount),
        F
      );
    },
    t1 = (y) => {
      const k = { ...s, ...(a.mount ? o : {}) };
      return p1(y) ? k : _e(y) ? I(k, y) : y.map((S) => I(k, S));
    },
    c1 = (y, k) => ({
      invalid: !!I((k || r).errors, y),
      isDirty: !!I((k || r).dirtyFields, y),
      isTouched: !!I((k || r).touchedFields, y),
      error: I((k || r).errors, y),
    }),
    B2 = (y) => {
    ...
    Qe = (y, k = {}) => {
      ...
      return (
        ...
        u.mount.add(y),
        S
          ? F && n1(o, y, k.disabled ? void 0 : I(o, y, u5(S._f)))
          : M(y, !0, k.value),
        {
    ...
    j6 = () => n.shouldFocusError && cr(l, (y) => y && I(r.errors, y), u.mount),
    k6 = (y, k) => async (S) => {
    ...
    cl = (y, k = {}) => {
      I(l, y) &&
        ...
        k.keepDirty ||
          (L1(r.dirtyFields, y),
          (r.isDirty = k.defaultValue ? B(y, I(s, y)) : B())),
        k.keepError || (L1(r.errors, y), C.isValid && f()),
        p.state.next({ ...r }));
    },
    M6 = (y, k = {}) => {
      const S = y || s,
      ...
      if ((k.keepDefaultValues || (s = S), !k.keepValues)) {
        if (k.keepDirtyValues || v)
          for (const Z of u.mount)
            I(r.dirtyFields, Z) ? n1(P, Z, I(o, Z)) : T(Z, I(P, Z));
        else {
          if (y6 && p1(y))
            for (const Z of u.mount) {
              const U = I(l, Z);
      ...
      (u = {
        ...
        !a.mount && t(),
        (a.mount = !C.isValid || !!k.keepIsValid),
...
function A3(e = {}) {
  ...
  return (
    ...
    eu({
      ...
      next: (o) => {
        ba(o, s._proxyFormState, s._updateFormState, !0) &&
          l({ ...s._formState });
      },
    }),
    Oe.useEffect(() => {
...
function vu(e) {
  const t = M1(),
    ...
    o = () => {
      const { name1: a, name2: u, name3: c, name4: m } = s();
      if (!a && !u && !c && !m) {
        n(!1);
        return;
      }
...
function Tu(e) {
  ...
  const x = (d) => {
      ...
      v = d.changedTouches[0].target;
      const h = f.pageY - p - v.offsetHeight / 2,
        w = f.pageX - C - v.offsetWidth / 2;
    ...
    A = (d, f) => {
      d.preventDefault(),
        !(v && ((v.style.position = "static"), v.style.top !== "59.5px")) &&
          (n(!0),
          s(l.map((h, w) => (w === f ? (h.answer = !0) : (h.answer = !1), h))),
          a(l[f]),
...
function Uu(e) {
  ...
  N.useEffect(() => {
    if (s.current) {
      ...
      if (((g = M.left), (A = M.top), o.current)) {
        const L = o.current.getBoundingClientRect();
        (l[0].top = L.top + L.height / 2 - M.top - 21.5),
          (l[0].left = Math.ceil(L.left + L.width / 2 - M.left - 10));
      }
      if (a.current) {
        const L = a.current.getBoundingClientRect();
        (l[1].top = L.top + L.height / 2 - M.top - 21.5),
          (l[1].left = Math.ceil(L.left + L.width / 2 - M.left - 10));
      }
      if (u.current) {
        const L = u.current.getBoundingClientRect();
        (l[2].top = L.top + L.height / 2 - M.top - 21.5),
          (l[2].left = Math.ceil(L.left + L.width / 2 - M.left - 10));
      }
      if (c.current) {
        const L = c.current.getBoundingClientRect();
        (l[3].top = L.top + L.height / 2 - M.top - 21.5),
          (l[3].left = Math.ceil(L.left + L.width / 2 - M.left - 10));
      }
    }
  });
  const [m, C] = N.useState([
  ...
  let g = 0,
    ...
    f;
  const h = (M) => {
      const L = M.changedTouches[0];
      if (
        ((f = M.changedTouches[0].target.closest("svg")),
        (p.current = "transparent"),
        f)
      ) {
        d = f.width.animVal.value;
        const D = L.pageY - A,
          z = L.pageX - g - d / 2;
    ...
    j = () => {
      if (f) {
        const M = parseInt(f.style.left),
          L = parseInt(f.style.top);
        let E = -3;
        l.forEach((D, z) => {
          D.left + 4 >= M &&
            D.left - 4 <= M &&
            ...
            (p.current = "#fff"),
            (E = z),
            E === 3 ? (t(Y("true")), x(!0)) : (t(Y("false")), x(!1)),
            f &&
              ((f.style.left = D.left + "px"), (f.style.top = D.top + "px")));
        }),
          E === -3 && n(!1),
          C(m.map((D, z) => (E === z ? (D.check = !0) : (D.check = !1), D)));
      }
    };
  return i.jsx(i.Fragment, {
    children: i.jsxs("div", {
                ...
                i.jsxs(
                  "div",
                  {
                    ...
                    children: [
                      i.jsx("span", {
                        style: {
                          background: M.check ? p.current : "transparent",
                        },
                        className: x2.answer,
                        ref: L === 0 ? o : L === 1 ? a : L === 2 ? u : c,
                      }),
                      i.jsx("span", { className: x2.name, children: M.name }),
                    ],
                  },
                  L
                )
...
const Vu = "_taskInfo_rqrfn_1",
  ...
  sc = "" + new URL("hour-d47865e3.svg", import.meta.url).href;
function ic(e) {
  const t = M1(),
    { selectAnswer: n, checkClick: r } = e,
    l = N.useRef(0),
    s = N.useRef(50),
    o = {
      transform: `translate(-50%, -50%) rotate(${l.current}deg)`,
    ...
    g = (d) => {
      ...
      let j, M;
      l.current >= 0 ? (M = l.current % 360) : (M = 360 + (l.current % 360));
      const L = Math.floor(M / 30);
      M % 30 > 15 ? (j = L * 30 + 30) : (j = L * 30),
        j === 360 && (j = 0),
        j !== p &&
          ((a.current = a.current.map(
            (E) => (E.deg === j ? (E.check = !0) : (E.check = !1), E)
          )),
          v(j)),
        ((((M % 360 >= 0 && M % 360 <= 90) || M % 360 > 270) && w <= m) ||
          (M % 360 > 90 && M % 360 <= 270 && w >= m)) &&
        ((M % 360 >= 0 && M % 360 <= 180 && h >= u) ||
          (M % 360 > 180 && h <= u))
          ? (l.current = l.current + 1.5)
          : (l.current = l.current - 1.5),
        c(h),
        C(w);
    },
    A = () => {
      n(!0), t(Y(p === 180 ? "true" : "false"));
    };
  return i.jsx(i.Fragment, {
    children: i.jsxs("div", {
        ...
        i.jsxs("div", {
          ...
          children: [
            i.jsx("div", {
              ...
              children: a.current.map((d, f) =>
                i.jsx(
                  "span",
                  {
                    className: d.check ? w2.check : "",
                    children: i.jsx("img", { src: d.src, alt: f + 1 + "" }),
                  },
                  f
                )
              ),
            ...
            i.jsx("div", {
              ...
              children: i.jsx("div", {
                ...
                onTouchMove: (d) => g(d),
                onTouchEnd: () => A(),
                children: i.jsx("img", { src: sc, alt: "hour" }),
              }),
            }),
            i.jsx("div", {
              ...
              "label",
              {
                ...
                children: [
                  ...
                  i.jsxs("div", {
                    className: D3.answer,
                    children: [
                      i.jsx("img", { src: a[m], alt: c.nameEN }),
    ...
    children: i.jsxs("div", {
      ...
      children: [
        ...
        i.jsxs("div", {
          className: k2.task,
          children: [
            i.jsx("img", { src: Gc, alt: "code" }),
            i.jsx("div", { className: k2.number, children: "2" }),
            i.jsx(f8, { click: C, value: l, className: k2.number }),
            i.jsx(f8, { click: x, value: p, className: k2.number }),
            i.jsx("img", { src: Kc, alt: "code", className: k2.code }),
            i.jsxs("p", {
              className: k2.text,
...
function ff(e) {
  ...
  const u = (p) => {
    ...
    C = () => {
      if (a < 50) {
        s("name1", ""), o && o.style.setProperty("--var-width", "0%");
        return;
      }
      o &&
        (n(!0),
...
function yf(e) {
  ...
  const v = N.useRef([!1, !1, !1, !1]),
    x = (d) => {
      ...
      h && (v.current = v.current.map((M, L) => (L === +h ? !1 : M)));
      const w = f.pageY - m - C.offsetHeight / 2,
        j = f.pageX - c - C.offsetWidth / 2;
      (C.style.position = "absolute"),
        (C.style.zIndex = "1"),
        (C.style.left = j + "px"),
        (C.style.top = w + "px");
    ...
    g = (d) => {
      const f = d.changedTouches[0];
      C = d.changedTouches[0].target;
      const h = f.pageY - m - C.offsetHeight / 2,
        w = f.pageX - c - C.offsetWidth / 2;
      (C.style.position = "absolute"),
        (C.style.zIndex = "1"),
    ...
    A = (d) => {
      ...
      const f = C.getBoundingClientRect(),
        h = p.findIndex(
          (j) =>
            j.top - 5 <= f.top && j.top + 5 >= f.top && j.left + 5 >= f.left
        );
      if (h === -1) {
      ...
      C.setAttribute("data-index", h + ""),
        (v.current = v.current.map((j, M) => (M === h ? !0 : j)));
      let w = 0;
      for (let j = 0; j < v.current.length; j++) {
        const M = v.current[j];
        M && w++, w === 3 && (n(!0), t(Y(j === 3 && M ? "false" : "true")));
      }
    };
  return i.jsx(i.Fragment, {
    children: i.jsxs("div", {
...
function Sf(e) {
  ...
  const [f, h] = N.useState("15px"),
    ...
    [j, M] = N.useState(A),
    [L, E] = N.useState("29px"),
    D = { paddingRight: j, paddingBottom: L },
    ...
    T = () => {
      if (x1) {
        if (
          ...
          u(b7([4, 4])), h("20px"), s(!0), r(), a(!0), n(!0), t(!0);
          return;
        }
        return;
      }
    ...
    children: i.jsx("div", {
      ...
      children: i.jsxs("div", {
        ...
        children: [
          ...
          i.jsx(kf, { selectAnswer: g1, checkClick: l }),
          i.jsx("button", {
    ...
    children: [
      ...
      i.jsxs("main", {
        ...
        children: [
          i.jsx(Pa, { openTask: a }),
          i.jsx(Ra, { tasksEnd: l }),
          e && i.jsx(Sf, { openFirework: u, openTask: a, closePoints: o }),
          n && i.jsx(Af, {}),
...
d5.createRoot(document.getElementById("root")).render(
  i.jsx(Oe.StrictMode, {
    children: i.jsx(_o, { store: Zf, children: i.jsx(_f, {}) }),
  })
);
