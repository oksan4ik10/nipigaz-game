 ...
 */ (function (e) {
  function t(T, I) {
    ...
    e: for (; 0 < U; ) {
      var t1 = (U - 1) >>> 1,
        c1 = T[t1];
      if (0 < l(c1, I)) (T[t1] = I), (T[U] = c1), (U = t1);
      else break e;
    }
  }
  function n(T) {
  ...
  function r(T) {
    ...
    if (U !== I) {
      ...
      e: for (var t1 = 0, c1 = T.length, B2 = c1 >>> 1; t1 < B2; ) {
        ...
        if (0 > l(_3, U))
          de < c1 && 0 > l(Qe, _3)
            ? ((T[t1] = Qe), (T[de] = U), (t1 = de))
            : ((T[t1] = _3), (T[ke] = U), (t1 = ke));
        else if (de < c1 && 0 > l(Qe, U)) (T[t1] = Qe), (T[de] = U), (t1 = de);
        else break e;
      }
    }
    return I;
  ...
  function l(T, I) {
    var U = T.sortIndex - I.sortIndex;
    return U !== 0 ? U : T.id - I.id;
  }
  ...
  function j(T, I) {
    (g = !1), x && ((x = !1), C(N), (N = -1)), (v = !0);
    var U = p;
    try {
      for (
        h(I), d = n(a);
        d !== null && (!(d.expirationTime > I) || (T && !Q()));
    ...
    (e.unstable_scheduleCallback = function (T, I, U) {
      ...
      switch (
        (typeof U == "object" && U !== null
          ? ((U = U.delay), (U = typeof U == "number" && 0 < U ? t1 + U : t1))
          : (U = t1),
        T)
      ) {
        case 1:
      ...
      return (
        ...
        U > t1
          ? ((T.sortIndex = U),
            ...
            n(a) === null &&
              T === n(c) &&
              (x ? (C(N), (N = -1)) : (x = !0), Z1(w, U - t1)))
          : ((T.sortIndex = c1), t(a, T), g || v || ((g = !0), x1(j))),
        T
      );
    }),
...
var u3 = We.ReactCurrentBatchConfig,
  c4 = !0;
function fs(e, t, n, r) {
  var l = X,
    s = u3.transition;
...
var Is = Fe && "TextEvent" in window && !H3,
...
var Xs = Fe && "documentMode" in document && 11 >= document.documentMode,
  G2 = null,
  T5 = null,
  X3 = null,
  P5 = !1;
  ...
  B8(function () {
    ...
    e: {
      ...
      if (p !== void 0) {
        ...
        0 < x.length &&
          ((p = new v(p, g, null, n, m)), d.push({ event: p, listeners: x }));
      }
    }
    if (!(t & 7)) {
      e: {
        ...
        if (
          ...
          if (
            ...
            t: {
              for (x = v, C = g, f = 0, h = x; h; h = W2(h)) f++;
      ...
      N &&
        (l0 &&
          ...
          (X2 || N !== "onCompositionStart"
            ...
            : ((Je = m),
              (Sr = "value" in Je ? Je.value : Je.textContent),
              (X2 = !0))),
        (S = d4(c, N)),
        0 < S.length &&
          ((N = new Q6(N, e, null, n, m)),
          d.push({ event: N, listeners: S }),
          M ? (N.data = M) : ((M = i0(n)), M !== null && (N.data = M)))),
        (M = Is ? zs(e, n) : Ds(e, n)) &&
...
function o9(e, t, n) {
  if (O1.current !== C2) throw Error(_(168));
  b(O1, t), b(W1, n);
}
function x0(e, t, n) {
  var r = e.stateNode;
...
function y2() {
  if (!Bn && Oe !== null) {
    ...
    try {
      ...
      throw (Oe !== null && (Oe = Oe.slice(e + 1)), H8(kr, y2), l);
    } finally {
      (X = t), (Bn = !1);
    }
  }
...
function k0(e, t, n) {
  (se[ie++] = Ie), (se[ie++] = ze), (se[ie++] = R2), (R2 = e);
  var r = Ie;
  e = ze;
  var l = 32 - ge(r) - 1;
  (r &= ~(1 << l)), (n += 1);
  ...
  if (30 < s) {
    ...
    (s = (r & ((1 << o) - 1)).toString(32)),
      (r >>= o),
      (l -= o),
      (Ie = (1 << (32 - ge(t) + l)) | (n << l) | r),
      (ze = s + e);
  } else (Ie = (1 << s) | (n << l) | r), (ze = e);
}
function Nr(e) {
  ...
  switch (e.tag) {
      ...
      return (
        (t =
          t.nodeType !== 1 || n.toLowerCase() !== t.nodeName.toLowerCase()
            ...
            : t),
        t !== null
          ? ((e.stateNode = t), (q1 = e), (K1 = s2(t.firstChild)), !0)
          : !1
      );
    case 6:
      return (
    ...
    case 13:
      return (
        ...
        t !== null
          ? ((n = R2 !== null ? { id: Ie, overflow: ze } : null),
            (e.memoizedState = {
              dehydrated: t,
              treeContext: n,
...
function zt(e) {
  ...
  if (
    ...
    for (; t; ) j0(e, t), (t = s2(t.nextSibling));
  }
  if ((c9(e), e.tag === 13)) {
  ...
  } else K1 = q1 ? s2(e.stateNode.nextSibling) : null;
  return !0;
}
function M0() {
  for (var e = K1; e; ) e = s2(e.nextSibling);
}
function m3() {
  (K1 = q1 = null), (l1 = !1);
}
...
var ii = We.ReactCurrentBatchConfig;
function pe(e, t) {
  if (e && e.defaultProps) {
...
function Z0(e) {
  ...
  function l(C, f) {
    return (C = a2(C, f)), (C.index = 0), (C.sibling = null), C;
  }
  function s(C, f, h) {
    return (
      (C.index = h),
  ...
  function g(C, f, h, w) {
    for (
      var j = null, S = null, M = f, N = (f = 0), z = null;
      M !== null && N < h.length;
      N++
    ) {
      M.index > N ? ((z = M), (M = null)) : (z = M.sibling);
      var P = p(C, M, h[N], w);
      if (P === null) {
        M === null && (M = z);
        break;
    ...
    if (N === h.length) return n(C, M), l1 && M2(C, N), j;
    if (M === null) {
      for (; N < h.length; N++)
        (M = d(C, h[N], w)),
          M !== null &&
            ((f = s(M, f, N)), S === null ? (j = M) : (S.sibling = M), (S = M));
      return l1 && M2(C, N), j;
    }
    for (M = r(C, M); N < h.length; N++)
      (z = v(M, C, N, h[N], w)),
        z !== null &&
  ...
  function x(C, f, h, w) {
    ...
    for (
      var S = (j = null), M = f, N = (f = 0), z = null, P = h.next();
      M !== null && !P.done;
      N++, P = h.next()
    ) {
      M.index > N ? ((z = M), (M = null)) : (z = M.sibling);
      var Q = p(C, M, P.value, w);
      if (Q === null) {
        M === null && (M = z);
        break;
      }
      e && M && Q.alternate === null && t(C, M),
        (f = s(Q, f, N)),
        S === null ? (j = Q) : (S.sibling = Q),
        (S = Q),
        (M = z);
    }
    if (P.done) return n(C, M), l1 && M2(C, N), j;
    if (M === null) {
      for (; !P.done; N++, P = h.next())
        (P = d(C, P.value, w)),
          P !== null &&
            ((f = s(P, f, N)), S === null ? (j = P) : (S.sibling = P), (S = P));
      return l1 && M2(C, N), j;
    }
    for (M = r(C, M); !P.done; N++, P = h.next())
      (P = v(M, C, N, P.value, w)),
        P !== null &&
          (e && P.alternate !== null && M.delete(P.key === null ? N : P.key),
          (f = s(P, f, N)),
          S === null ? (j = P) : (S.sibling = P),
          (S = P));
    return (
...
var bt = We.ReactCurrentDispatcher,
    ...
    : (e === t
        ...
        : ((e.flags |= 128),
          ...
          n.tag === 1 &&
            (n.alternate === null
              ? (n.tag = 17)
              : ((t = De(-1, 1)), (t.tag = 2), i2(n, t, 1))),
          (n.lanes |= 1)),
      e);
}
var hi = We.ReactCurrentOwner,
  $1 = !1;
function R1(e, t, n, r) {
...
function Y5(e, t, n, r, l, s) {
  t7(e, t);
  var o = (t.flags & 128) !== 0;
  if (!r && !o) return l && u9(t, n, !1), Be(e, t, s);
...
function r7(e, t, n) {
    ...
    return (
      !(o & 1) && t.child !== l
        ? ((r = t.child),
          ...
          (r.pendingProps = a),
          (t.deletions = null))
        : ((r = a2(l, a)), (r.subtreeFlags = l.subtreeFlags & 14680064)),
      u !== null ? (s = a2(u, s)) : ((s = T2(s, o, n, null)), (s.flags |= 2)),
      (s.return = t),
      (r.return = t),
      (r.sibling = s),
      (t.child = r),
  ...
  return (
    (s = e.child),
    (e = s.sibling),
    (r = a2(s, { mode: "visible", children: r.children })),
    !(t.mode & 1) && (r.lanes = n),
    (r.return = t),
    (r.sibling = null),
    e !== null &&
  ...
  if (((u = (o & e.childLanes) !== 0), $1 || u)) {
    if (((r = k1), r !== null)) {
      ...
      (l = l & (r.suspendedLanes | o) ? 0 : l),
        l !== 0 &&
          l !== s.retryLane &&
          ((s.retryLane = l), Ue(e, l), xe(r, e, l, -1));
    }
...
function Be(e, t, n) {
  ...
  if (t.child !== null) {
    for (
      e = t.child, n = a2(e, e.pendingProps), t.child = n, n.return = t;
      e.sibling !== null;

    )
      (e = e.sibling), (n = n.sibling = a2(e, e.pendingProps)), (n.return = t);
    n.sibling = null;
  }
  return t.child;
}
...
function C7(e, t) {
  ...
  if (r & 30 || r & e.expiredLanes || t) t = A4(e, r);
    ...
    H |= 2;
    var s = h7();
    (k1 !== e || A1 !== t) && ((Pe = null), (x3 = d1() + 500), N2(e, t));
    do
      try {
        Si();
        break;
      ...
      switch (((e.finishedWork = l), (e.finishedLanes = r), t)) {
        ...
        case 3:
          if (
            ...
            e.timeoutHandle = z5(L2.bind(null, e, B1, Pe), t);
            break;
          }
          L2(e, B1, Pe);
          break;
        case 4:
          ...
          if (
            ...
            e.timeoutHandle = z5(L2.bind(null, e, B1, Pe), r);
            break;
          }
          L2(e, B1, Pe);
          break;
...
function D2(e) {
  ...
  try {
    ...
    (X = r), (ue.transition = n), (H = t), !(H & 6) && y2();
  }
}
function br() {
  (G1 = r3.current), e1(r3);
...
function Jr() {
  (v1 === 0 || v1 === 3 || v1 === 2) && (v1 = 4),
    k1 === null || (!(z2 & 268435455) && !(X4 & 268435455)) || qe(k1, A1);
}
function A4(e, t) {
  var n = H;
  H |= 2;
  var r = h7();
  (k1 !== e || A1 !== t) && ((Pe = null), N2(e, t));
  do
    try {
      Li();
      break;
...
function c3() {
  if (e2 !== null) {
    var e = K8(S4),
      ...
      n = X;
    try {
      if (((ue.transition = null), (X = 16 > e ? 16 : e), e2 === null))
        var r = !1;
      else {
...
function y7(e, t) {
  t === 0 &&
    (e.mode & 1
      ...
      : (t = 1));
  var n = z1();
  (e = Ue(e, t)), e !== null && (xt(e, t, n), H1(e, n));
}
function Zi(e) {
  var t = e.memoizedState,
    n = 0;
      ...
      e: {
        ...
        if (((r = o.element), s.isDehydrated))
          if (
            ...
            for (
              K1 = s2(t.stateNode.containerInfo.firstChild),
                q1 = t,
                l1 = !0,
                me = null,
                n = E0(t, null, r, n),
  ...
  switch (e.tag) {
    case 3:
      ...
      if (t.current.memoizedState.isDehydrated) {
        ...
        n !== 0 &&
          (jr(t, n | 1), H1(t, d1()), !(H & 6) && ((x3 = d1() + 500), y2()));
      }
      break;
    case 13:
      D2(function () {
  ...
  s = to(
    function () {
      function a(v) {
        ...
        if (((g = d), qi(m, v))) return g;
        var x = r(v);
        return l !== void 0 && l(g, x) ? g : ((m = v), (d = x));
      }
      var c = !1,
        m,
        d,
...
function fo(e = p2) {
  ...
  return function (r, l = {}) {
    ...
    const v = E.useCallback(
      ...
      g = T7(c.addNestedSub, a.getState, m || a.getState, v, s);
...
function _o({
  ...
  const a = t || p2;
  return E.createElement(a.Provider, { value: o }, n);
}
function D7(e = p2) {
  const t = e === p2 ? N7 : s6(e);
  return function () {
    ...
    J: function (s, o) {
      var u = Array.isArray(s),
        a = (function (m, d) {
          ...
          var g = $7(d);
          delete g[r1];
          for (var x = d3(g), A = 0; A < x.length; A++) {
            var C = x[A];
            g[C] = e(C, m || !!g[C].enumerable);
          }
                ...
                if (m) {
                  ...
                  if (g === 4)
                    F2(p, function (h) {
                      ...
                      F2(d, function (h) {
                        p[h] !== void 0 || f3(p, h) || ((v[h] = !1), be(m));
                      });
                  else if (g === 5) {
                    if ((r(m) && (be(m), (v.length = !0)), p.length < d.length))
...
function fu(e) {
  ...
  var x = Go.apply(void 0, g),
    A = P4;
  a && (A = ru(c2({ trace: !cu }, typeof a == "object" && a)));
  var C = new iu(x),
    f = C;
...
function f2(e, t) {
  function n() {
    ...
    if (t) {
      ...
      return c2(
        c2({ type: e, payload: s.payload }, "meta" in s && { meta: s.meta }),
...
function kn(e) {
  ...
  l.forEach(function (m) {
    var d = r[m],
      ...
      v,
      g;
    "reducer" in d ? ((v = d.reducer), (g = d.prepare)) : (v = d),
      (s[m] = v),
      (o[p] = v),
      (u[m] = g ? f2(p, g) : f2(p));
  });
...
(function () {
  function e(t, n, r) {
    var l = f2(t + "/fulfilled", function (c, m, d, p) {
        return {
          payload: c,
          meta: r5(c2({}, p || {}), {
            arg: d,
      ...
      o = f2(t + "/rejected", function (c, m, d, p, v) {
        return {
          payload: p,
                      ...
                      Promise.race([
                        ...
                        Promise.resolve(
                          n(c, {
                            ...
                            signal: g.signal,
                            abort: A,
                            rejectWithValue: function (P, Q) {
                              return new l5(P, Q);
                            },
                            fulfillWithValue: function (P, Q) {
                              return new J9(P, Q);
                            },
                          })
                        ).then(function (P) {
...
const Ru = "_task__info_15avx_1",
  Iu = "_task_15avx_1",
  zu = "_list_15avx_95",
  g2 = { task__info: Ru, task: Iu, list: zu },
  ...
  u8 = async (e, t, n, r, l) => {
    ...
    if (!z && (!I1(m) || !I1(d))) {
      ...
      if (!I1(f) && !isNaN(f)) {
        ...
        I1(q.value) || ($ = x1 > q.value), I1(g1.value) || (B = x1 < g1.value);
      } else {
        const x1 = s.valueAsDate || new Date(f),
          Z1 = (U) => new Date(new Date().toDateString() + " " + U),
          T = s.type == "time",
          I = s.type == "week";
        _e(q.value) &&
          f &&
      ...
      if (($ || B) && (Q(!!$, q.message, g1.message, Te.max, Te.min), !n))
        return w(j[g].message), j;
    }
    if ((a || c) && !z && (_e(f) || (l && Array.isArray(f)))) {
      const $ = Q2(a),
        B = Q2(c),
        q = !I1($.value) && f.length > +$.value,
        g1 = !I1(B.value) && f.length < +B.value;
    ...
    if (p && !z && _e(f)) {
      ...
      if (
        R4($) &&
        !f.match($) &&
        ((j[g] = { type: Te.pattern, message: B, ref: s, ...P(Te.pattern, B) }),
        !n)
      )
        return w(B), j;
    }
    if (v) {
      if (t2(v)) {
        const $ = await v(f, t),
          B = o8($, h);
        if (B && ((j[g] = { ...B, ...P(Te.validate, B.message) }), !n))
          return w(B.message), j;
      } else if (y1(v)) {
        let $ = {};
        for (const B in v) {
          if (!le($) && !n) break;
          ...
          q &&
            (($ = { ...q, ...P(B, q.message) }), w(q.message), n && (j[g] = $));
        }
        if (!le($) && ((j[g] = { ref: h, ...$ }), !n)) return j;
      }
    }
    return w(!0), j;
  };
...
function da(e = {}, t) {
  ...
  const d = {
    ...
    f = async (y) => {
      if (d.isValid || y) {
        const k = n.resolver ? le((await z()).errors) : await Q(l, !0);
        k !== r.isValid && p.state.next({ isValid: k });
      }
    },
    h = (y) => d.isValidating && p.state.next({ isValidating: y }),
    w = (y, k = [], L, F, O = !0, Z = !0) => {
      if (F && L) {
        if (((u.action = !0), Z && Array.isArray(D(l, y)))) {
          const V = L(D(l, y), F.argA, F.argB);
          O && n1(l, y, V);
        }
        if (Z && Array.isArray(D(r.errors, y))) {
          const V = L(D(r.errors, y), F.argA, F.argB);
          O && n1(r.errors, y, V), ca(r.errors, y);
        }
        if (d.touchedFields && Z && Array.isArray(D(r.touchedFields, y))) {
          const V = L(D(r.touchedFields, y), F.argA, F.argB);
          O && n1(r.touchedFields, y, V);
        }
    ...
    j = (y, k) => {
      n1(r.errors, y, k), p.state.next({ errors: r.errors });
    },
    S = (y, k, L, F) => {
      const O = D(l, y);
      if (O) {
        const Z = D(o, y, p1(L) ? D(s, y) : L);
    ...
    N = (y, k, L, F) => {
      const O = D(r.errors, y),
        Z = d.isValid && C3(k) && r.isValid !== k;
      if (
        (e.delayError && L
          ? ((c = C(() => j(y, L))), c(e.delayError))
          : (clearTimeout(m),
            (c = null),
            L ? n1(r.errors, y, L) : L1(r.errors, y)),
        (L ? !E2(O, L) : O) || !le(F) || Z)
      ) {
        const V = {
          ...F,
    ...
    B = (y, k) => (y && k && n1(o, y, k), !E2(t1(), s)),
    q = (y, k, L) =>
      ta(y, a, { ...(u.mount ? o : p1(k) ? s : _e(y) ? { [y]: k } : k) }, L, k),
    g1 = (y) =>
      Lt(D(u.mount ? o : s, y, e.shouldUnregister ? D(s, y, []) : [])),
    x1 = (y, k, L = {}) => {
      const F = D(l, y);
      let O = k;
      if (F) {
      ...
      (L.shouldDirty || L.shouldTouch) &&
        M(y, O, L.shouldTouch, L.shouldDirty, !0),
        L.shouldValidate && U(y);
    },
    Z1 = (y, k, L) => {
      for (const F in k) {
        const O = k[F],
          Z = `${y}.${F}`,
          V = D(l, Z);
        (a.array.has(y) || !I4(O) || (V && !V._f)) && !l3(O)
          ? Z1(Z, O, L)
          : x1(Z, O, L);
      }
    },
      ...
      if (O) {
        ...
        const f1 = Z(),
          ...
          fl =
            ...
            aa($2, D(r.touchedFields, L), r.isSubmitted, x, g),
          jn = r8(L, a, $2);
        n1(o, L, f1),
          $2
            ? (O._f.onBlur && O._f.onBlur(y), c && c(0))
            : O._f.onChange && O._f.onChange(y);
        const Mn = M(L, f1, $2, !1),
          dl = !le(Mn) || jn;
        if (
          (!$2 && p.values.next({ name: L, type: y.type, values: { ...o } }),
          fl)
        )
          return (
        ...
        if ((!$2 && jn && p.state.next({ ...r }), h(!0), n.resolver)) {
          ...
          (V = (await u8(O, o, A, n.shouldUseNativeValidation))[L]),
            ...
            F && (V ? (u1 = !1) : d.isValid && (u1 = await Q(l, !0)));
        F && (O._f.deps && U(O._f.deps), N(L, u1, V, Mn));
      }
    },
    U = async (y, k = {}) => {
      let L, F;
      const O = s5(y);
      if ((h(!0), n.resolver)) {
        const Z = await P(p1(y) ? y : O);
        (L = le(Z)), (F = y ? !O.some((V) => D(Z, V)) : L);
      } else
        y
          ? ((F = (
              await Promise.all(
      ...
      return (
        p.state.next({
          ...(!_e(y) || (d.isValid && L !== r.isValid) ? {} : { name: y }),
          ...(n.resolver || !y ? { isValid: L } : {}),
          errors: r.errors,
          isValidating: !1,
        }),
        k.shouldFocus &&
          !F &&
          cr(l, (Z) => Z && D(r.errors, Z), y ? O : a.mount),
        F
      );
    },
    t1 = (y) => {
      const k = { ...s, ...(u.mount ? o : {}) };
      return p1(y) ? k : _e(y) ? D(k, y) : y.map((L) => D(k, L));
    },
    c1 = (y, k) => ({
      invalid: !!D((k || r).errors, y),
      isDirty: !!D((k || r).dirtyFields, y),
      isTouched: !!D((k || r).touchedFields, y),
      error: D((k || r).errors, y),
    }),
    B2 = (y) => {
      y && s5(y).forEach((k) => L1(r.errors, k)),
        p.state.next({ errors: y ? r.errors : {} });
    },
    ke = (y, k, L) => {
      const F = (D(l, y, { _f: {} })._f || {}).ref;
      n1(r.errors, y, { ...k, ref: F }),
        p.state.next({ name: y, errors: r.errors, isValid: !1 }),
        L && L.shouldFocus && F && F.focus && F.focus();
    },
    _3 = (y, k) =>
      t2(y)
        ? p.values.subscribe({ next: (L) => y(q(void 0, k), L) })
        : q(y, k, !0),
    de = (y, k = {}) => {
      for (const L of y ? s5(y) : a.mount)
        a.mount.delete(L),
          a.array.delete(L),
      ...
      p.values.next({ values: { ...o } }),
        p.state.next({ ...r, ...(k.keepDirty ? { isDirty: B() } : {}) }),
        !k.keepIsValid && f();
    },
    Qe = (y, k = {}) => {
      let L = D(l, y);
      ...
      return (
        ...
        a.mount.add(y),
        L
          ? F && n1(o, y, k.disabled ? void 0 : D(o, y, a5(L._f)))
          : S(y, !0, k.value),
        {
    ...
    k6 = () => n.shouldFocusError && cr(l, (y) => y && D(r.errors, y), a.mount),
    j6 = (y, k) => async (L) => {
      ...
      L1(r.errors, "root"),
        le(r.errors)
          ? (p.state.next({ errors: {} }), await y(F, L))
    ...
    cl = (y, k = {}) => {
      D(l, y) &&
        (p1(k.defaultValue)
          ? T(y, D(s, y))
          : (T(y, k.defaultValue), n1(s, y, k.defaultValue)),
        k.keepTouched || L1(r.touchedFields, y),
        k.keepDirty ||
          (L1(r.dirtyFields, y),
          (r.isDirty = k.defaultValue ? B(y, D(s, y)) : B())),
        k.keepError || (L1(r.errors, y), d.isValid && f()),
        p.state.next({ ...r }));
    },
    M6 = (y, k = {}) => {
      const L = y || s,
      ...
      if ((k.keepDefaultValues || (s = L), !k.keepValues)) {
        ...
        (o = e.shouldUnregister ? (k.keepDefaultValues ? Ye(s) : {}) : Ye(O)),
      ...
      if (((document.body.style.overflow = "auto"), f)) {
        ...
        l.forEach((z, P) => {
          z.left + 4 >= S &&
            ...
            (p.current = "#fff"),
            (N = P),
            N === 3 ? (t(Y("true")), g(!0)) : (t(Y("false")), g(!1)),
            f &&
              ((f.style.left = z.left + "px"), (f.style.top = z.top + "px")));
        }),
          N === -3 && n(!1),
          d(m.map((z, P) => (N === P ? (z.check = !0) : (z.check = !1), z)));
      }
    };
  return i.jsx(i.Fragment, {
    children: i.jsxs("div", {
                ...
                i.jsxs(
                  "div",
                  {
                    ...
                    children: [
                      ...
                      i.jsx("span", { className: x2.name, children: S.name }),
                    ],
                  },
                  M
                )
...
const Ua = "_taskInfo_14e3d_1",
  Ba = "_clock_14e3d_21",
  $a = "_numbers_14e3d_39",
  Wa = "_check_14e3d_61",
  Qa = "_arrows_14e3d_149",
  Ha = "_minutes_14e3d_171",
  w2 = {
    taskInfo: Ua,
    clock: Ba,
    numbers: $a,
  ...
  Ya = "" + new URL("hour-d47865e3.svg", import.meta.url).href;
function Xa(e) {
  const t = M1(),
    { selectAnswer: n, checkClick: r } = e,
    l = E.useRef(0),
    s = E.useRef(50),
    o = {
      transform: `rotate(${l.current}deg)`,
      transformOrigin: `${s.current}% 50%`,
    },
    u = E.useRef([
    ...
    g = (C) => {
      const f = C.changedTouches[0];
      c(f.clientX), d(f.clientY), (document.body.style.overflow = "hidden");
    },
    x = (C) => {
      const f = C.changedTouches[0],
        h = f.clientX,
      ...
      let j, S;
      l.current >= 0 ? (S = l.current % 360) : (S = 360 + (l.current % 360));
      const M = S % 360,
        N = M >= 0 && M < 90 ? 1 : M >= 90 && M < 180 ? 2 : M >= 270 ? 4 : 3;
      (N === 1 && a <= h && m >= w) ||
      (N === 2 && a <= h && m <= w) ||
      (N === 3 && a >= h && m <= w) ||
      (N === 4 && a >= h && m >= w)
        ...
        : (l.current = l.current - 2);
      const z = Math.floor(S / 30);
      S % 30 > 15 ? (j = z * 30 + 30) : (j = z * 30),
        j === 360 && (j = 0),
        j !== p &&
          ((u.current = u.current.map(
            (P) => (P.deg === j ? (P.check = !0) : (P.check = !1), P)
          )),
          v(j)),
        c(h),
        d(w);
        ...
        i.jsxs("div", {
          ...
          children: [
            i.jsx("div", {
              ...
              children: u.current.map((C, f) =>
                i.jsx(
                  "span",
                  { className: C.check ? w2.check : "", children: C.value },
                  f
                )
              ),
            }),
            i.jsx("div", {
              ...
              children: i.jsx("div", {
                ...
                onTouchMove: (C) => x(C),
                onTouchEnd: () => A(),
                children: i.jsx("img", { src: Ya, alt: "hour" }),
              }),
            }),
            i.jsx("div", {
...
const Ga = "_taskInfo_smbtj_1",
  Ka = "_task_smbtj_1",
  qa = "_label_smbtj_21",
  ba = "_input_smbtj_41",
  Ja = "_answer_smbtj_47",
  D3 = { taskInfo: Ga, task: Ka, label: qa, input: ba, answer: Ja },
  ec = (e) => {
...
const ic = "_task__info_ejqpt_1",
  oc = "_form_ejqpt_9",
  uc = "_numbers_ejqpt_23",
  ac = "_numbersActive_ejqpt_23",
  cc = "_userAnswer_ejqpt_57",
  fc = "_range_ejqpt_65",
  dc = "_progress_ejqpt_207",
  k2 = {
    task__info: ic,
    form: oc,
    numbers: uc,
...
const pc = "_taskInfo_1ghr2_1",
  hc = "_task_1ghr2_1",
  mc = "_taskAnswer_1ghr2_23",
  vc = "_answer_1ghr2_43",
  yc = "_zero_1ghr2_61",
  gc = "_taskZeros_1ghr2_73",
  xc = "_none_1ghr2_109",
  wc = "_success_1ghr2_115",
  kc = "_danger_1ghr2_121",
  X1 = {
    taskInfo: pc,
    task: hc,
    taskAnswer: mc,
...
const Pc = "_taskInfo_wtwrs_1",
  Oc = "_task_wtwrs_1",
  Rc = "_text_wtwrs_21",
  Ic = "_number_wtwrs_43",
  j2 = { taskInfo: Pc, task: Oc, text: Rc, number: Ic },
  c8 =
    ...
    children: i.jsxs("div", {
      ...
      children: [
        ...
        i.jsxs("div", {
          className: j2.task,
          children: [
            i.jsx("img", { src: zc, alt: "code" }),
            i.jsx("div", { className: j2.number, children: "2" }),
            i.jsx(f8, { click: d, value: l, className: j2.number }),
            i.jsx(f8, { click: g, value: p, className: j2.number }),
            i.jsx("img", { src: Dc, alt: "code", className: j2.code }),
            i.jsxs("p", {
              className: j2.text,
...
const Uc = "_taskInfo_sc4le_1",
  Bc = "_task_sc4le_1",
  $c = "_taskAnswer_sc4le_31",
  Wc = "_danger_sc4le_69",
  Qc = "_cart_sc4le_75",
  Qt = { taskInfo: Uc, task: Bc, taskAnswer: $c, danger: Wc, cart: Qc },
  Hc = (e) => {
    const {
      index: t,
      color: n,
...
const Xc = "_taskInfo_sk5qx_1",
  Gc = "_form_sk5qx_11",
  Kc = "_label_sk5qx_23",
  qc = "_input_sk5qx_39",
  Le = { taskInfo: Xc, form: Gc, label: Kc, input: qc };
function bc(e) {
  const t = M1(),
    { selectAnswer: n, checkClick: r } = e,
...
const Jc = "_taskInfo_1r0oy_1",
  ef = "_task_1r0oy_1",
  tf = "_taskAnswer_1r0oy_27",
  nf = "_taskText_1r0oy_41",
  rf = "_taskCheck_1r0oy_59",
  lf = "_taskCups_1r0oy_73",
  re = {
    taskInfo: Jc,
    task: ef,
    taskAnswer: tf,
...
const of = "_task__info_1e5cd_1",
  uf = "_subtitels_1e5cd_17",
  af = "_points_1e5cd_31",
  f5 = { task__info: of, subtitels: uf, points: af };
function cf() {
    ...
    children: i.jsx("div", {
      ...
      children: i.jsxs("div", {
        ...
        children: [
          ...
          i.jsx(ff, { selectAnswer: g1, checkClick: l }),
          i.jsx("button", {
    ...
    children: [
      ...
      i.jsxs("main", {
        ...
        children: [
          i.jsx(Pu, { openTask: u }),
          i.jsx(Ou, { tasksEnd: l }),
          e && i.jsx(pf, { openFirework: a, openTask: u, closePoints: o }),
          n && i.jsx(hf, {}),
...
d5.createRoot(document.getElementById("root")).render(
  i.jsx(Re.StrictMode, {
    children: i.jsx(_o, { store: vf, children: i.jsx(mf, {}) }),
  })
);
