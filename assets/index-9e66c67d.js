  ...
  function k(T, O) {
    ...
    try {
      ...
      if (C !== null) var B2 = !0;
        ...
        var ke = n(c);
        ke !== null && Z1(w, ke.startTime - O), (B2 = !1);
      }
      return B2;
    } finally {
      (C = null), (p = V), (v = !1);
...
var H8 = J1.unstable_scheduleCallback,
  ...
  kr = J1.unstable_ImmediatePriority,
    ...
    if (!(t & 7)) {
      ...
      E &&
        ...
        0 < M.length &&
          ...
          L ? (E.data = L) : ((L = s0(n)), L !== null && (E.data = L)))),
        (L = zi ? Ii(e, n) : Di(e, n)) &&
...
function y2() {
  if (!Bn && Re !== null) {
    ...
    try {
      ...
      throw (Re !== null && (Re = Re.slice(e + 1)), H8(kr, y2), l);
    } finally {
      (X = t), (Bn = !1);
    }
  }
...
function Z0(e) {
  ...
  function x(d, f, h, w) {
    for (
      var k = null, M = null, L = f, E = (f = 0), D = null;
      L !== null && E < h.length;
      E++
    ) {
    ...
    if (E === h.length) return n(d, L), l1 && M2(d, E), k;
    if (L === null) {
      for (; E < h.length; E++)
        (L = C(d, h[E], w)),
          L !== null &&
            ((f = i(L, f, E)), M === null ? (k = L) : (M.sibling = L), (M = L));
      return l1 && M2(d, E), k;
    }
  ...
  function g(d, f, h, w) {
    ...
    for (
      var M = (k = null), L = f, E = (f = 0), D = null, z = h.next();
      L !== null && !z.done;
      E++, z = h.next()
    ) {
      L.index > E ? ((D = L), (L = null)) : (D = L.sibling);
    ...
    if (z.done) return n(d, L), l1 && M2(d, E), k;
    if (L === null) {
      for (; !z.done; E++, z = h.next())
        (z = C(d, z.value, w)),
          z !== null &&
            ((f = i(z, f, E)), M === null ? (k = z) : (M.sibling = z), (M = z));
      return l1 && M2(d, E), k;
    }
...
function Fr(e, t) {
  switch ((J(ft, t), J(ct, e), J(Ee, jt), (e = t.nodeType), e)) {
    case 9:
    case 11:
...
function br() {
  (v1 === 0 || v1 === 3 || v1 === 2) && (v1 = 4),
    k1 === null || (!(I2 & 268435455) && !(X4 & 268435455)) || qe(k1, A1);
}
function A4(e, t) {
  var n = H;
  H |= 2;
...
U8 = qr;
V8 = D2;
var Is = { usingClientEntryPoint: !1, Events: [kt, q2, $4, D8, F8, qr] },
  z3 = {
...
ee.hydrateRoot = function (e, t, n) {
  ...
  if (
    ...
    (t = k7(t, null, e, 1, n ?? null, l, !1, i, o)),
    (e[Ue] = t.current),
    ot(e),
    r)
  )
 ...
 */ var j1 = typeof Symbol == "function" && Symbol.for,
  s6 = j1 ? Symbol.for("react.element") : 60103,
  ...
  a6 = j1 ? Symbol.for("react.async_mode") : 60111,
  on = j1 ? Symbol.for("react.concurrent_mode") : 60111,
  an = j1 ? Symbol.for("react.forward_ref") : 60112,
  un = j1 ? Symbol.for("react.suspense") : 60113,
...
function fa(e) {
  ...
  var d = new sa(g),
    f = d;
  Array.isArray(p) ? (f = k3([g], p)) : typeof p == "function" && (f = p(d));
...
function du(e = {}, t) {
  ...
  const C = {
    ...
    f = async (y) => {
      if (C.isValid || y) {
        const j = n.resolver ? le((await D()).errors) : await Q(l, !0);
    ...
    g1 = (y) =>
      Lt(I(a.mount ? o : i, y, e.shouldUnregister ? I(i, y, []) : [])),
    x1 = (y, j, S = {}) => {
      const F = I(l, y);
      let P = j;
      if (F) {
    ...
    O = async (y) => {
      ...
      if (P) {
        ...
        if (
          ...
          return (
            C.isValid && f(), dl && p.state.next({ name: S, ...(jn ? {} : Mn) })
          );
    ...
    t1 = (y) => {
      const j = { ...i, ...(a.mount ? o : {}) };
      return p1(y) ? j : _e(y) ? I(j, y) : y.map((S) => I(j, S));
    },
    c1 = (y, j) => ({
      invalid: !!I((j || r).errors, y),
      isDirty: !!I((j || r).dirtyFields, y),
      isTouched: !!I((j || r).touchedFields, y),
      error: I((j || r).errors, y),
    }),
    B2 = (y) => {
    ...
    Qe = (y, j = {}) => {
      ...
      return (
        ...
        u.mount.add(y),
        S
          ? F && n1(o, y, j.disabled ? void 0 : I(o, y, u5(S._f)))
          : M(y, !0, j.value),
        {
    ...
    k6 = () => n.shouldFocusError && cr(l, (y) => y && I(r.errors, y), u.mount),
    j6 = (y, j) => async (S) => {
      ...
      L1(r.errors, "root"),
        le(r.errors)
          ...
          : (j && (await j({ ...r.errors }, S)), k6(), setTimeout(k6)),
        p.state.next({
          isSubmitted: !0,
          isSubmitting: !1,
    ...
    cl = (y, j = {}) => {
      I(l, y) &&
        ...
        j.keepDirty ||
          (L1(r.dirtyFields, y),
          (r.isDirty = j.defaultValue ? B(y, I(i, y)) : B())),
                ...
                s.jsxs(
                  "div",
                  {
                    ...
                    children: [
                      ...
                      s.jsx("span", { className: x2.name, children: M.name }),
                    ],
                  },
                  L
                )
  ...
  const t = M1(),
    ...
    g = (d) => {
      const f = d.changedTouches[0],
        h = f.clientX,
        w = f.clientY;
      l.current > 180 ? (i.current = 55) : (i.current = 53);
      let k, M;
      l.current >= 0 ? (M = l.current % 360) : (M = 360 + (l.current % 360));
      const L = Math.floor(M / 30);
      M % 30 > 15 ? (k = L * 30 + 30) : (k = L * 30),
        k === 360 && (k = 0),
        k !== p &&
          ((a.current = a.current.map(
            (E) => (E.deg === k ? (E.check = !0) : (E.check = !1), E)
          )),
          v(k)),
              ...
              children: a.current.map((d, f) =>
                s.jsx(
                  "span",
                  {
                    ...
                    children: s.jsx("img", { src: d.src, alt: f + 1 + "" }),
                  },
                  f
                )
              ),
...
const Qc = "_taskInfo_wtwrs_1",
  ...
  Yc = "_text_wtwrs_21",
  Xc = "_number_wtwrs_43",
  j2 = { taskInfo: Qc, task: Hc, text: Yc, number: Xc },
  c8 =
      ...
      children: [
        ...
        s.jsxs("div", {
          ...
          children: [
            ...
            s.jsx("div", { className: j2.number, children: "2" }),
            s.jsx(f8, { click: C, value: l, className: j2.number }),
            s.jsx(f8, { click: x, value: p, className: j2.number }),
            s.jsx("img", { src: Kc, alt: "code", className: j2.code }),
            s.jsxs("p", {
              className: j2.text,
  ...
  const v = N.useRef([!1, !1, !1, !1]),
    ...
    A = (d) => {
      ...
      C.setAttribute("data-index", h + ""),
        (v.current = v.current.map((k, M) => (M === h ? !0 : k)));
      let w = 0;
      for (let k = 0; k < v.current.length; k++) {
        const M = v.current[k];
        M && w++, w === 3 && (n(!0), t(Y(k === 3 && M ? "false" : "true")));
      }
    };
  return s.jsx(s.Fragment, {
    children: s.jsxs("div", {
...
function Sf(e) {
  ...
  const [f, h] = N.useState("15px"),
    ...
    [k, M] = N.useState(A),
    [L, E] = N.useState("29px"),
    D = { paddingRight: k, paddingBottom: L },
    ...
    children: s.jsx("div", {
      ...
      children: s.jsxs("div", {
        ...
        children: [
          ...
          s.jsx(jf, { selectAnswer: g1, checkClick: l }),
          s.jsx("button", {
