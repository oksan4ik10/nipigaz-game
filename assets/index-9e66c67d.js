 ...
 */ (function (e) {
  function t(T, z) {
    ...
    e: for (; 0 < U; ) {
      var t1 = (U - 1) >>> 1,
        c1 = T[t1];
      if (0 < l(c1, z)) (T[t1] = z), (T[U] = c1), (U = t1);
      else break e;
    }
  }
  function n(T) {
  ...
  function k(T, z) {
    ...
    try {
      ...
      if (d !== null) var B2 = !0;
        ...
        var je = n(c);
        je !== null && Z1(w, je.startTime - z), (B2 = !1);
      }
      return B2;
    } finally {
      (d = null), (p = U), (v = !1);
...
var zs = Fe && "TextEvent" in window && !H3,
...
function j0(e, t, n) {
  (se[ie++] = ze), (se[ie++] = Ie), (se[ie++] = R2), (R2 = e);
  var r = ze;
  e = Ie;
  var l = 32 - ge(r) - 1;
  (r &= ~(1 << l)), (n += 1);
  ...
  switch (e.tag) {
    ...
    case 13:
      return (
        ...
        t !== null
          ? ((n = R2 !== null ? { id: ze, overflow: Ie } : null),
            (e.memoizedState = {
              dehydrated: t,
              treeContext: n,
...
function Z0(e) {
  ...
  function g(C, f, h, w) {
    for (
      var k = null, S = null, M = f, N = (f = 0), I = null;
      M !== null && N < h.length;
      N++
    ) {
  ...
  function x(C, f, h, w) {
    ...
    for (
      var S = (k = null), M = f, N = (f = 0), I = null, P = h.next();
      M !== null && !P.done;
      N++, P = h.next()
    ) {
      M.index > N ? ((I = M), (M = null)) : (I = M.sibling);
...
function H0(e, t, n) {
  return z2 & 21
    ? (we(n, t) || ((n = G8()), (i1.lanes |= n), (I2 |= n), (e.baseState = !0)),
      t)
...
V8 = qr;
U8 = D2;
var Ii = { usingClientEntryPoint: !1, Events: [jt, q2, $4, D8, F8, qr] },
  z3 = {
...
ee.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED = Ii;
...
const Ru = "_task__info_15avx_1",
  zu = "_task_15avx_1",
  Iu = "_list_15avx_95",
  g2 = { task__info: Ru, task: zu, list: Iu },
...
var Q2 = (e) => (y1(e) && !R4(e) ? e : { value: e, message: "" }),
  u8 = async (e, t, n, r, l) => {
    ...
    if ((a || c) && !I && (_e(f) || (l && Array.isArray(f)))) {
      const $ = Q2(a),
        B = Q2(c),
    ...
    Z1 = (y, j, L) => {
      for (const F in j) {
        const O = j[F],
          Z = `${y}.${F}`,
          V = D(l, Z);
        (a.array.has(y) || !z4(O) || (V && !V._f)) && !l3(O)
          ? Z1(Z, O, L)
          : x1(Z, O, L);
      }
    },
    ...
    k = () => {
      if (((document.body.style.overflow = "auto"), f)) {
        ...
        l.forEach((I, P) => {
          ...
          N === -3 && n(!1),
          d(m.map((I, P) => (N === P ? (I.check = !0) : (I.check = !1), I)));
      }
    };
  return i.jsx(i.Fragment, {
    children: i.jsxs("div", {
...
const Ua = "_taskInfo_1szq5_1",
  Ba = "_clock_1szq5_21",
  $a = "_numbers_1szq5_39",
  Wa = "_check_1szq5_61",
  Qa = "_arrows_1szq5_149",
  Ha = "_minutes_1szq5_171",
  w2 = {
    taskInfo: Ua,
    clock: Ba,
    numbers: $a,
  ...
  const t = M1(),
    ...
    x = (C) => {
      ...
      try {
        ...
        const I = Math.floor(S / 30);
        S % 30 > 15 ? (k = I * 30 + 30) : (k = I * 30),
          k === 360 && (k = 0),
          k !== p &&
...
const Pc = "_taskInfo_wtwrs_1",
  ...
  Rc = "_text_wtwrs_21",
  zc = "_number_wtwrs_43",
  k2 = { taskInfo: Pc, task: Oc, text: Rc, number: zc },
  c8 =
...
function pf(e) {
  ...
  if (c[0] !== 4) {
    ...
    (v = z.question),
      ...
      (x = z.paddingAnswer),
      (A = z.paddingQuestion),
      (C = z.paddingAnswerBtm ? z.paddingAnswerBtm : "29px");
  }
